...
# Trainmatlab.v.0/aps_weather_model_nan_check.m
...
# Trainmatlab.v.0/aps_weather_model_nan_check.m:27
    lon=double(longrid[:,:,1])
# Trainmatlab.v.0/aps_weather_model_nan_check.m:28
    lat=double(latgrid[:,:,1])
# Trainmatlab.v.0/aps_weather_model_nan_check.m:29
    # step_levels
...
# Trainmatlab.v.0/aps_weather_model_nan_check.m:47
            temp_data=e[:,:,step_level[k]]
# Trainmatlab.v.0/aps_weather_model_nan_check.m:49
...
# Trainmatlab.v.0/aps_weather_model_nan_check.m:50
        else:
            if n_nan == n_pixels:
                if k == 1:
                    error('Weird seems like the top of the atmopshere has no data')
                Temp[:,:,step_level[k]]=Temp[:,:,step_level[k - 1]]
# Trainmatlab.v.0/aps_weather_model_nan_check.m:57
                e[:,:,step_level[k]]=e[:,:,step_level[k - 1]]
# Trainmatlab.v.0/aps_weather_model_nan_check.m:58
            else:
                Temp[:,:,step_level[k]]=nanmean(nanmean(Temp[:,:,step_level[k]]))
# Trainmatlab.v.0/aps_weather_model_nan_check.m:60
                e[:,:,step_level[k]]=nanmean(nanmean(e[:,:,step_level[k]]))
# Trainmatlab.v.0/aps_weather_model_nan_check.m:61
