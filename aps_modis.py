...
# DB    02/2016     Include aps_systemcall and suppress filename output.
    ...
    curdir=copy(pwd)
# Trainmatlab.v.0/aps_modis.m:38
    if start_step == 0:
...
# Trainmatlab.v.0/aps_modis.m:71
        else:
