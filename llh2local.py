...
#                                       is a column vector
    ...
    a=6378137.0
# matlab/llh2local.m:46
    e=0.0820944379497
# matlab/llh2local.m:47
    #Convert to radians
#   llh=llh*pi/180;
#   origin=origin*pi/180;
    llh=dot(double(llh),pi) / 180
# matlab/llh2local.m:52
    origin=dot(double(origin),pi) / 180
# matlab/llh2local.m:53
    #Do the projection
    
    z=llh[2,:] != 0
# matlab/llh2local.m:57
    dlambda=llh[1,z] - origin[1]
# matlab/llh2local.m:59
