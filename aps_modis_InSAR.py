...
# Trainmatlab.v.0/aps_modis_InSAR.m
...
# Trainmatlab.v.0/aps_modis_InSAR.m:64
    modis_file_suffix_interp=matlabarray(cat(recal_str,'ZWD_surf.xyz'))
# Trainmatlab.v.0/aps_modis_InSAR.m:65
    datestructure='yyyymmdd'
# Trainmatlab.v.0/aps_modis_InSAR.m:67
...
# Trainmatlab.v.0/aps_modis_InSAR.m:74
        if ischar(look_angle) == 1:
            look_angle=load(look_angle)
# Trainmatlab.v.0/aps_modis_InSAR.m:78
            look_angle=look_angle.la
# Trainmatlab.v.0/aps_modis_InSAR.m:79
        # longitude, latitude and time information
        ps=load(ll_matfile)
# Trainmatlab.v.0/aps_modis_InSAR.m:83
        load(psver)
        dates=ps.day
# Trainmatlab.v.0/aps_modis_InSAR.m:85
        lonlat=ps.lonlat
# Trainmatlab.v.0/aps_modis_InSAR.m:86
        if strcmp(getparm('small_baseline_flag'),'y'):
            sb_flag=1
# Trainmatlab.v.0/aps_modis_InSAR.m:90
        else:
            sb_flag=0
# Trainmatlab.v.0/aps_modis_InSAR.m:92
        n_ifg=ps.n_ifg
# Trainmatlab.v.0/aps_modis_InSAR.m:95
        if sb_flag == 1:
            # for SB
            ifg_number=cat(arange(1,n_ifg)).T
# Trainmatlab.v.0/aps_modis_InSAR.m:99
            ifgday_ix=ps.ifgday_ix
# Trainmatlab.v.0/aps_modis_InSAR.m:100
            ifgday_ix[drop_ifg_index,:]=[]
# Trainmatlab.v.0/aps_modis_InSAR.m:102
            ifg_number[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_modis_InSAR.m:103
            ifgs_ix=matlabarray(cat(ifgday_ix,ifg_number))
# Trainmatlab.v.0/aps_modis_InSAR.m:106
            ifgs_ix_no_interp=copy(ifgs_ix)
# Trainmatlab.v.0/aps_modis_InSAR.m:107
        else:
            # slightly different for PS.
            date_slave_ix=cat(arange(1,n_ifg)).T
# Trainmatlab.v.0/aps_modis_InSAR.m:111
            ifg_number=cat(arange(1,n_ifg)).T
# Trainmatlab.v.0/aps_modis_InSAR.m:112
            date_slave_ix[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_modis_InSAR.m:115
            ifg_number[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_modis_InSAR.m:116
            date_master_ix=repmat(ps.master_ix,size(date_slave_ix,1),1)
# Trainmatlab.v.0/aps_modis_InSAR.m:119
            ifgs_ix=matlabarray(cat(date_master_ix,date_slave_ix,ifg_number))
# Trainmatlab.v.0/aps_modis_InSAR.m:122
            ifgs_ix_no_interp=copy(ifgs_ix)
# Trainmatlab.v.0/aps_modis_InSAR.m:123
    else:
        sb_flag=0
# Trainmatlab.v.0/aps_modis_InSAR.m:128
        psver=2
# Trainmatlab.v.0/aps_modis_InSAR.m:129
        lonlat=load(ll_matfile)
# Trainmatlab.v.0/aps_modis_InSAR.m:131
        lonlat=lonlat.lonlat
# Trainmatlab.v.0/aps_modis_InSAR.m:132
        if ischar(look_angle) == 1:
            look_angle=load(look_angle)
# Trainmatlab.v.0/aps_modis_InSAR.m:136
            look_angle=look_angle.la
# Trainmatlab.v.0/aps_modis_InSAR.m:137
        # getting the dates in jullian format
        ifgs_dates=load(ifgday_matfile)
# Trainmatlab.v.0/aps_modis_InSAR.m:143
        ifgs_dates=ifgs_dates.ifgday
# Trainmatlab.v.0/aps_modis_InSAR.m:144
        dates=reshape(ifgs_dates,[],1)
# Trainmatlab.v.0/aps_modis_InSAR.m:145
        dates=unique(dates)
# Trainmatlab.v.0/aps_modis_InSAR.m:146
        dates=datenum(num2str(dates),'yyyymmdd')
# Trainmatlab.v.0/aps_modis_InSAR.m:147
        dates=sort(dates)
# Trainmatlab.v.0/aps_modis_InSAR.m:148
        # getting the ix position for the master and slave dates with respect
    # to the times
        date_master=datenum(num2str(ifgs_dates[:,1]),'yyyymmdd')
# Trainmatlab.v.0/aps_modis_InSAR.m:152
        date_slave=datenum(num2str(ifgs_dates[:,2]),'yyyymmdd')
# Trainmatlab.v.0/aps_modis_InSAR.m:153
        ifg_number=cat(arange(1,size(date_master,1))).T
# Trainmatlab.v.0/aps_modis_InSAR.m:154
        for k in arange(1,size(date_master,1)).reshape(-1):
            date_master_ix[k,1]=find(date_master[k,1] == dates)
# Trainmatlab.v.0/aps_modis_InSAR.m:158
            date_slave_ix[k,1]=find(date_slave[k,1] == dates)
# Trainmatlab.v.0/aps_modis_InSAR.m:159
        # ix interferograms
        ifgs_ix=matlabarray(cat(date_master_ix,date_slave_ix,ifg_number))
# Trainmatlab.v.0/aps_modis_InSAR.m:163
        n_ifg=size(ifgs_dates,1)
# Trainmatlab.v.0/aps_modis_InSAR.m:166
        fprintf('Check the InSAR dates, this has not been tested \\n')
    
    InSAR_datapath=matlabarray(cat('.',filesep))
# Trainmatlab.v.0/aps_modis_InSAR.m:172
    apsname=matlabarray(cat(InSAR_datapath,'tca',num2str(psver),'.mat'))
# Trainmatlab.v.0/aps_modis_InSAR.m:173
    apssbname=matlabarray(cat(InSAR_datapath,'tca_sb',num2str(psver),'.mat'))
# Trainmatlab.v.0/aps_modis_InSAR.m:174
    n_dates=length(dates)
# Trainmatlab.v.0/aps_modis_InSAR.m:178
    n_points=size(lonlat,1)
# Trainmatlab.v.0/aps_modis_InSAR.m:179
    ## loading the meris data
# initialisation
    d_modis=NaN(cat(n_points,n_dates))
# Trainmatlab.v.0/aps_modis_InSAR.m:183
    
    d_modis_no_interp=NaN(cat(n_points,n_dates))
# Trainmatlab.v.0/aps_modis_InSAR.m:184
    
    SAR_modis_perc=NaN(cat(n_dates,1))
# Trainmatlab.v.0/aps_modis_InSAR.m:187
    
    counter=0
# Trainmatlab.v.0/aps_modis_InSAR.m:188
    counter_threshold=0
# Trainmatlab.v.0/aps_modis_InSAR.m:189
    ix_no_modis=matlabarray([])
# Trainmatlab.v.0/aps_modis_InSAR.m:190
    ix_no_modis_coverage=matlabarray([])
# Trainmatlab.v.0/aps_modis_InSAR.m:191
    ix_no_modis_no_interp_file=matlabarray([])
# Trainmatlab.v.0/aps_modis_InSAR.m:192
...
# Trainmatlab.v.0/aps_modis_InSAR.m:196
...
# Trainmatlab.v.0/aps_modis_InSAR.m:199
...
# Trainmatlab.v.0/aps_modis_InSAR.m:200
...
# Trainmatlab.v.0/aps_modis_InSAR.m:207
                d_modis_no_interp[:,k]=xyz_output_nointerp[:,3]
# Trainmatlab.v.0/aps_modis_InSAR.m:210
                SAR_modis_perc[k,1]=dot((1 - sum(isnan(xyz_output_nointerp[:,3])) / n_points),100)
# Trainmatlab.v.0/aps_modis_InSAR.m:212
                ...
                # by clouds.
                    keep_modis=0
# Trainmatlab.v.0/aps_modis_InSAR.m:216
                    counter_threshold=counter_threshold + 1
# Trainmatlab.v.0/aps_modis_InSAR.m:217
                else:
                    # good modis acquisition
                    keep_modis=1
# Trainmatlab.v.0/aps_modis_InSAR.m:220
...
# Trainmatlab.v.0/aps_modis_InSAR.m:260
    for k in arange(1,n_dates).reshape(-1):
...
# Trainmatlab.v.0/aps_modis_InSAR.m:281
    ph_SAR_modis_no_interp=multiply(dot(- 4,pi) / lambda_,d_modis_no_interp)
# Trainmatlab.v.0/aps_modis_InSAR.m:282
...
# Trainmatlab.v.0/aps_modis_InSAR.m:291
            ifgs_ix[ix_ifg_reject,:]=[]
# Trainmatlab.v.0/aps_modis_InSAR.m:292
            ix_ifg_reject=find(ix_no_modis[k] == ifgs_ix[:,1])
# Trainmatlab.v.0/aps_modis_InSAR.m:294
            ifgs_ix[ix_ifg_reject,:]=[]
# Trainmatlab.v.0/aps_modis_InSAR.m:295
            clear('ix_ifg_reject')
...
# Trainmatlab.v.0/aps_modis_InSAR.m:304
            ifgs_ix_no_interp[ix_ifg_reject_no_interp,:]=[]
# Trainmatlab.v.0/aps_modis_InSAR.m:305
            ix_ifg_reject_no_interp=find(ix_no_modis_no_interp_file[k] == ifgs_ix_no_interp[:,1])
# Trainmatlab.v.0/aps_modis_InSAR.m:307
            ifgs_ix_no_interp[ix_ifg_reject_no_interp,:]=[]
# Trainmatlab.v.0/aps_modis_InSAR.m:308
...
# Trainmatlab.v.0/aps_modis_InSAR.m:314
    if isempty(ifgs_ix):
...
# Trainmatlab.v.0/aps_modis_InSAR.m:367
    modis.ix_no_data = copy(ix_no_modis_coverage)
# Trainmatlab.v.0/aps_modis_InSAR.m:368
