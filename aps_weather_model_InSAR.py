...
# Trainmatlab.v.0/aps_weather_model_InSAR.m
...
# 05/2016   DB      Include merra2
    ...
    wetoutfile='_ZWD.xyz'
# Trainmatlab.v.0/aps_weather_model_InSAR.m:45
    hydroutfile='_ZHD.xyz'
# Trainmatlab.v.0/aps_weather_model_InSAR.m:46
...
# Trainmatlab.v.0/aps_weather_model_InSAR.m:53
    ll_matfile=getparm_aps('ll_matfile',1)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:54
    ifgday_matfile=getparm_aps('ifgday_matfile')
# Trainmatlab.v.0/aps_weather_model_InSAR.m:55
    model_type=lower(model_type)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:57
    if strcmpi(model_type,'era'):
        weather_model_datapath=getparm_aps('era_datapath',1)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:59
    else:
        if strcmpi(model_type,'merra') or strcmpi(model_type,'merra2'):
            weather_model_datapath=getparm_aps('merra_datapath',1)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:61
    
    lambda_=dot(getparm_aps('lambda',1),100)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:63
    
    datestructure='yyyymmdd'
# Trainmatlab.v.0/aps_weather_model_InSAR.m:64
    
    look_angle=getparm_aps('look_angle',1)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:65
    # loading the data
    if strcmp(stamps_processed,'y'):
        fprintf('Stamps processed structure \\n')
        ps=load(ll_matfile)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:71
        load(psver)
        dates=ps.day
# Trainmatlab.v.0/aps_weather_model_InSAR.m:73
        lonlat=ps.lonlat
# Trainmatlab.v.0/aps_weather_model_InSAR.m:74
        if ischar(look_angle) == 1:
            look_angle=load(look_angle)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:76
            look_angle=look_angle.la
# Trainmatlab.v.0/aps_weather_model_InSAR.m:77
        # getting the dropped ifgs
        drop_ifg_index=getparm('drop_ifg_index')
# Trainmatlab.v.0/aps_weather_model_InSAR.m:81
        if strcmp(getparm('small_baseline_flag'),'y'):
            sb_flag=1
# Trainmatlab.v.0/aps_weather_model_InSAR.m:84
        else:
            sb_flag=0
# Trainmatlab.v.0/aps_weather_model_InSAR.m:86
        n_ifg=ps.n_ifg
# Trainmatlab.v.0/aps_weather_model_InSAR.m:89
        if sb_flag == 1:
            # for SB
            ifg_number=cat(arange(1,n_ifg)).T
# Trainmatlab.v.0/aps_weather_model_InSAR.m:93
            ifgday_ix=ps.ifgday_ix
# Trainmatlab.v.0/aps_weather_model_InSAR.m:94
            ifgday_ix[drop_ifg_index,:]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:96
            ifg_number[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:97
            ifgs_ix=matlabarray(cat(ifgday_ix,ifg_number))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:100
        else:
            # slightly different for PS.
            date_slave_ix=cat(arange(1,n_ifg)).T
# Trainmatlab.v.0/aps_weather_model_InSAR.m:103
            ifg_number=cat(arange(1,n_ifg)).T
# Trainmatlab.v.0/aps_weather_model_InSAR.m:104
            date_slave_ix[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:107
            ifg_number[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:108
            date_master_ix=repmat(ps.master_ix,size(date_slave_ix,1),1)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:111
            ifgs_ix=matlabarray(cat(date_master_ix,date_slave_ix,ifg_number))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:114
    else:
        psver=2
# Trainmatlab.v.0/aps_weather_model_InSAR.m:117
        sb_flag=0
# Trainmatlab.v.0/aps_weather_model_InSAR.m:120
        lonlat=load(ll_matfile)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:123
        lonlat=lonlat.lonlat
# Trainmatlab.v.0/aps_weather_model_InSAR.m:124
        if ischar(look_angle) == 1:
            look_angle=load(look_angle)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:128
            look_angle=look_angle.la
# Trainmatlab.v.0/aps_weather_model_InSAR.m:129
        # getting the dates in jullian format
        ifgs_dates=load(ifgday_matfile)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:133
        ifgs_dates=ifgs_dates.ifgday
# Trainmatlab.v.0/aps_weather_model_InSAR.m:134
        dates=reshape(ifgs_dates,[],1)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:135
        dates=unique(dates)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:136
        dates=datenum(num2str(dates),'yyyymmdd')
# Trainmatlab.v.0/aps_weather_model_InSAR.m:137
        dates=sort(dates)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:138
        # getting the ix position for the master and slave dates with respect
    # to the times
        date_master=datenum(num2str(ifgs_dates[:,1]),'yyyymmdd')
# Trainmatlab.v.0/aps_weather_model_InSAR.m:142
        date_slave=datenum(num2str(ifgs_dates[:,2]),'yyyymmdd')
# Trainmatlab.v.0/aps_weather_model_InSAR.m:143
        ifg_number=cat(arange(1,size(date_master,1))).T
# Trainmatlab.v.0/aps_weather_model_InSAR.m:144
        drop_ifg_index=matlabarray([])
# Trainmatlab.v.0/aps_weather_model_InSAR.m:146
        date_slave[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:149
        date_master[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:150
        ifg_number[drop_ifg_index]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:151
        for k in arange(1,size(date_master,1)).reshape(-1):
            date_master_ix[k,1]=find(date_master[k,1] == dates)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:153
            date_slave_ix[k,1]=find(date_slave[k,1] == dates)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:154
        # ix interferograms
        ifgs_ix=matlabarray(cat(date_master_ix,date_slave_ix,ifg_number))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:158
        n_ifg=size(ifgs_dates,1)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:161
        ps.day = copy(dates)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:164
    
    n_dates=length(dates)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:166
    InSAR_datapath=matlabarray(cat('.'))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:167
    apsname=matlabarray(cat(InSAR_datapath,filesep,'tca',num2str(psver),'.mat'))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:168
    apssbname=matlabarray(cat(InSAR_datapath,filesep,'tca_sb',num2str(psver),'.mat'))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:169
    ## loading the ERA-I data
# initialisation
    d_wet=NaN(cat(size(lonlat,1),n_dates))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:175
    
    d_hydro=NaN(cat(size(lonlat,1),n_dates))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:176
    
    ix_no_weather_model_data=matlabarray([])
# Trainmatlab.v.0/aps_weather_model_InSAR.m:179
    counter=0
# Trainmatlab.v.0/aps_weather_model_InSAR.m:180
...
# Trainmatlab.v.0/aps_weather_model_InSAR.m:196
            d_hydro[:,k]=xyz_output[:,3]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:198
...
# Trainmatlab.v.0/aps_weather_model_InSAR.m:202
            d_wet[:,k]=xyz_output[:,3]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:205
            clear('xyz_output')
            counter=counter + 1
# Trainmatlab.v.0/aps_weather_model_InSAR.m:207
        else:
            # rejected list of ERA-I images
            ix_no_weather_model_data=matlabarray(cat(ix_no_weather_model_data,k))
# Trainmatlab.v.0/aps_weather_model_InSAR.m:211
...
# Trainmatlab.v.0/aps_weather_model_InSAR.m:252
            ifgs_ix[ix_ifg_reject,:]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:253
            ix_ifg_reject=find(ix_no_weather_model_data[k] == ifgs_ix[:,1])
# Trainmatlab.v.0/aps_weather_model_InSAR.m:255
            ifgs_ix[ix_ifg_reject,:]=[]
# Trainmatlab.v.0/aps_weather_model_InSAR.m:256
            clear('ix_ifg_reject')
    
    # computing the interferometric delay for each remaining interferogram
    n_ifg=size(ifgs_ix,1)
# Trainmatlab.v.0/aps_weather_model_InSAR.m:262
    if isempty(ifgs_ix):
    ...
    # present otherwize, its still a sar delay!
        good_ifg_data=1
# Trainmatlab.v.0/aps_weather_model_InSAR.m:275
        if eval(cat('sum(ph_SAR_',model_type,'(:,ifgs_ix(',num2str(k),',1)))==0 |  sum(ph_SAR_',model_type,'(:,ifgs_ix(',num2str(k),',2)))==0')):
            ...
            good_ifg_data=0
# Trainmatlab.v.0/aps_weather_model_InSAR.m:279
        if good_ifg_data == 1:
