...
# Trainmatlab.v.0/aps_powerlaw.m
...
# Trainmatlab.v.0/aps_powerlaw.m:57
    
    currdir=copy(pwd)
# Trainmatlab.v.0/aps_powerlaw.m:60
    
    plot_flag=0
# Trainmatlab.v.0/aps_powerlaw.m:61
    hydro=1
# Trainmatlab.v.0/aps_powerlaw.m:62
    wet=1
# Trainmatlab.v.0/aps_powerlaw.m:63
...
# Trainmatlab.v.0/aps_powerlaw.m:98
        if isempty(mountain_ridge) == 1:
            str_repr='y'
# Trainmatlab.v.0/aps_powerlaw.m:102
            str_vis='n'
# Trainmatlab.v.0/aps_powerlaw.m:103
        # data has been computed before - reporcess? - visualize?
        if length(mountain_ridge) > 0:
            str_repr=''
# Trainmatlab.v.0/aps_powerlaw.m:108
...
# Trainmatlab.v.0/aps_powerlaw.m:173
                else:
...
# Trainmatlab.v.0/aps_powerlaw.m:175
                    else:
...
# Trainmatlab.v.0/aps_powerlaw.m:177
                n_months=1
# Trainmatlab.v.0/aps_powerlaw.m:179
            else:
...
# Trainmatlab.v.0/aps_powerlaw.m:183
                end_year=str2num(sounding_end_date[1:4])
# Trainmatlab.v.0/aps_powerlaw.m:184
                start_str=sounding_start_date[5:6]
# Trainmatlab.v.0/aps_powerlaw.m:185
                end_str=sounding_end_date[5:6]
# Trainmatlab.v.0/aps_powerlaw.m:186
                if hydro == 1 and wet == 0:
...
# Trainmatlab.v.0/aps_powerlaw.m:190
                else:
                    if hydro == 0 and wet == 1:
...
# Trainmatlab.v.0/aps_powerlaw.m:192
                    else:
...
# Trainmatlab.v.0/aps_powerlaw.m:219
...
# Trainmatlab.v.0/aps_powerlaw.m:236
        alpha=getparm_aps('powerlaw_alpha')
# Trainmatlab.v.0/aps_powerlaw.m:237
...
# Trainmatlab.v.0/aps_powerlaw.m:246
        crop_flag=getparm_aps('crop_flag',1)
# Trainmatlab.v.0/aps_powerlaw.m:247
        ll_matfile=getparm_aps('ll_matfile',1)
# Trainmatlab.v.0/aps_powerlaw.m:250
        ll=load(ll_matfile)
# Trainmatlab.v.0/aps_powerlaw.m:251
        ll=ll.lonlat
# Trainmatlab.v.0/aps_powerlaw.m:252
        h0=getparm_aps('powerlaw_h0',1)
# Trainmatlab.v.0/aps_powerlaw.m:255
        alpha=getparm_aps('powerlaw_alpha',1)
# Trainmatlab.v.0/aps_powerlaw.m:256
        getparm_aps('powerlaw_xy_res',1)
        phuw_matfile=getparm_aps('phuw_matfile',1)
# Trainmatlab.v.0/aps_powerlaw.m:258
        hgt_matfile=getparm_aps('hgt_matfile',1)
# Trainmatlab.v.0/aps_powerlaw.m:259
        DEM_corr=getparm_aps('powerlaw_DEM_corr',1)
# Trainmatlab.v.0/aps_powerlaw.m:260
        bperp_matfile=getparm_aps('bperp_matfile',1)
# Trainmatlab.v.0/aps_powerlaw.m:261
        xy_rotatelocal_full,xy_local_full,local_origin_full=ll2rotatelocal(ll,heading,nargout=3)
# Trainmatlab.v.0/aps_powerlaw.m:264
        crop=matlabarray([])
# Trainmatlab.v.0/aps_powerlaw.m:268
        if strcmpi(crop_flag,'y'):
            if exist('area_ex.mat','file') == 2:
                crop=load('area_ex.mat')
# Trainmatlab.v.0/aps_powerlaw.m:271
            else:
                if exist('../area_ex.mat','file') == 2:
                    crop=load('../area_ex.mat')
# Trainmatlab.v.0/aps_powerlaw.m:273
                else:
                    crop=matlabarray([])
# Trainmatlab.v.0/aps_powerlaw.m:275
...
# Trainmatlab.v.0/aps_powerlaw.m:280
        else:
            ix_remove=matlabarray([])
# Trainmatlab.v.0/aps_powerlaw.m:282
        ll[ix_remove,:]=[]
# Trainmatlab.v.0/aps_powerlaw.m:284
        ix_convexhull=convhull(ll[:,1],ll[:,2])
# Trainmatlab.v.0/aps_powerlaw.m:287
        InSAR_convexhull=ll[ix_convexhull,:]
# Trainmatlab.v.0/aps_powerlaw.m:288
...
# Trainmatlab.v.0/aps_powerlaw.m:300
        fprintf('        Scaling and interpolation to a regular grid \\n\\n')
        # loading the unwrapped interferograms
        ph=load(phuw_matfile)
# Trainmatlab.v.0/aps_powerlaw.m:305
        ph=ph.ph_uw
# Trainmatlab.v.0/aps_powerlaw.m:306
        ix_phase_nan=isnan(ph)
# Trainmatlab.v.0/aps_powerlaw.m:309
        ph[ix_remove,:]=[]
# Trainmatlab.v.0/aps_powerlaw.m:312
        hgt=load(hgt_matfile)
# Trainmatlab.v.0/aps_powerlaw.m:316
        hgt=hgt.hgt
# Trainmatlab.v.0/aps_powerlaw.m:317
        hgt[ix_remove,:]=[]
# Trainmatlab.v.0/aps_powerlaw.m:319
        n_interferograms=size(ph,2)
# Trainmatlab.v.0/aps_powerlaw.m:322
        n_points=size(ph,1)
# Trainmatlab.v.0/aps_powerlaw.m:323
        # ifg based powerlaw correction?
        if length(alpha) == n_interferograms:
            hgt_max=max(hgt)
# Trainmatlab.v.0/aps_powerlaw.m:328
            hgt_scaled=repmat(hgt,1,size(ph,2))
# Trainmatlab.v.0/aps_powerlaw.m:329
            ifg_based_correction='y'
# Trainmatlab.v.0/aps_powerlaw.m:330
...
# Trainmatlab.v.0/aps_powerlaw.m:336
        else:
            # Scaling of the topography according to the powerlaw
            ifg_based_correction='n'
# Trainmatlab.v.0/aps_powerlaw.m:340
            ix=find(dot(h0,1000) - hgt < 0)
# Trainmatlab.v.0/aps_powerlaw.m:341
            if isempty(ix) != 1:
                error('myApp:argChk',cat('Power law is not valid above h0 heights,... \\nAbort,... \\n'))
            hgt_scaled=(dot(h0,1000) - hgt) ** (alpha)
# Trainmatlab.v.0/aps_powerlaw.m:345
...
# Trainmatlab.v.0/aps_powerlaw.m:394
        counter=0
# Trainmatlab.v.0/aps_powerlaw.m:396
        for k in arange(1,length(iterate.window_ix)).reshape(-1):
            counter=counter + size(iterate.window_ix[k],1)
# Trainmatlab.v.0/aps_powerlaw.m:398
...
# Trainmatlab.v.0/aps_powerlaw.m:404
                scaling=1.0 / nanmean(abs(dataset[:,k]))
# Trainmatlab.v.0/aps_powerlaw.m:405
                phase_data=dataset[:,n_interferograms + k]
# Trainmatlab.v.0/aps_powerlaw.m:406
            else:
                scaling=1.0 / nanmean(abs(dataset[:,1]))
# Trainmatlab.v.0/aps_powerlaw.m:408
                height_data=dataset[:,1]
# Trainmatlab.v.0/aps_powerlaw.m:409
                phase_data=dataset[:,1 + k]
# Trainmatlab.v.0/aps_powerlaw.m:410
            # estimating the reference, forced to be the same for all windows
            A_temp=zeros(cat(counter,length(iterate.window_ix)))
# Trainmatlab.v.0/aps_powerlaw.m:415
            data_temp=zeros(cat(counter,size(phase_data,2)))
# Trainmatlab.v.0/aps_powerlaw.m:416
            counter=1
# Trainmatlab.v.0/aps_powerlaw.m:417
...
# Trainmatlab.v.0/aps_powerlaw.m:437
...
# Trainmatlab.v.0/aps_powerlaw.m:447
                    hold('on')
...
# Trainmatlab.v.0/aps_powerlaw.m:455
            if length(alpha) == n_interferograms:
                dataset[:,n_interferograms + k]=dataset[:,n_interferograms + k] - coeff[end()]
# Trainmatlab.v.0/aps_powerlaw.m:458
            else:
                dataset[:,k + 1]=dataset[:,k + 1] - coeff[end()]
# Trainmatlab.v.0/aps_powerlaw.m:460
            ...
            if plot_flag == 1:
                ...
                if length(alpha) == n_interferograms:
                    ...
                    temp=getparm_aps('powerlaw_alpha')
# Trainmatlab.v.0/aps_powerlaw.m:468
                    xlabel(cat('(h_0-h)^{',num2str(temp[k]),'}'))
                else:
...
# Trainmatlab.v.0/aps_powerlaw.m:477
                for kk in arange(1,length(iterate.window_ix)).reshape(-1):
                    if length(alpha) == n_interferograms:
...
# Trainmatlab.v.0/aps_powerlaw.m:480
                    else:
...
# Trainmatlab.v.0/aps_powerlaw.m:482
                    hold('on')
...
# Trainmatlab.v.0/aps_powerlaw.m:516
        temp=load(ll_matfile)
# Trainmatlab.v.0/aps_powerlaw.m:517
        if strcmp(stamps_processed,'y'):
            temp=temp.lonlat
# Trainmatlab.v.0/aps_powerlaw.m:519
        n_points_original=size(temp,1)
# Trainmatlab.v.0/aps_powerlaw.m:522
        clear('temp')
        spatial_bands=getparm_aps('powerlaw_spatial_bands')
# Trainmatlab.v.0/aps_powerlaw.m:526
...
# Trainmatlab.v.0/aps_powerlaw.m:532
...
# Trainmatlab.v.0/aps_powerlaw.m:536
        else:
            h_ifg_number=1
# Trainmatlab.v.0/aps_powerlaw.m:538
...
# Trainmatlab.v.0/aps_powerlaw.m:588
...
# Trainmatlab.v.0/aps_powerlaw.m:616
        powerlaw_all_bands=getparm_aps('powerlaw_all_bands')
# Trainmatlab.v.0/aps_powerlaw.m:617
        hgt=load(hgt_matfile)
# Trainmatlab.v.0/aps_powerlaw.m:618
        hgt=hgt.hgt
# Trainmatlab.v.0/aps_powerlaw.m:619
        if strcmp(ifg_based_correction,'y'):
            n_interferograms=n_datasets / 2
# Trainmatlab.v.0/aps_powerlaw.m:623
        else:
            n_interferograms=n_datasets - 1
# Trainmatlab.v.0/aps_powerlaw.m:625
        # initialization
        n_points=size(hgt,1)
# Trainmatlab.v.0/aps_powerlaw.m:630
        ph_tropo_powerlaw=NaN(cat(n_points,n_interferograms))
# Trainmatlab.v.0/aps_powerlaw.m:631
        K_tropo_powerlaw=NaN(cat(n_points,n_interferograms))
# Trainmatlab.v.0/aps_powerlaw.m:632
        perc_cons_K_powerlaw=NaN(cat(n_interferograms,1))
# Trainmatlab.v.0/aps_powerlaw.m:633
...
# Trainmatlab.v.0/aps_powerlaw.m:662
                topo_data=topo_data.z_local_out
# Trainmatlab.v.0/aps_powerlaw.m:663
                phase_data=load(cat(save_path,filesep,'bandfilter_local_ifg_',num2str(ix_interferogram),'.mat'))
# Trainmatlab.v.0/aps_powerlaw.m:665
                phase_data=phase_data.z_local_out
# Trainmatlab.v.0/aps_powerlaw.m:666
                ifg_number=copy(k)
# Trainmatlab.v.0/aps_powerlaw.m:667
            else:
                # the first dataset was set the be the topography
                topo_data=load(cat(save_path,filesep,'bandfilter_local_hgt.mat'))
# Trainmatlab.v.0/aps_powerlaw.m:670
                topo_data=topo_data.z_local_out
# Trainmatlab.v.0/aps_powerlaw.m:671
                phase_data=load(cat(save_path,filesep,'bandfilter_local_ifg_',num2str(ix_interferogram),'.mat'))
# Trainmatlab.v.0/aps_powerlaw.m:673
                phase_data=phase_data.z_local_out
# Trainmatlab.v.0/aps_powerlaw.m:674
                ifg_number=1
# Trainmatlab.v.0/aps_powerlaw.m:675
...
# Trainmatlab.v.0/aps_powerlaw.m:680
            else:
                save_path_outlier_windows=matlabarray([])
# Trainmatlab.v.0/aps_powerlaw.m:682
            if k == 10000:
                debug_fig_linear=1
# Trainmatlab.v.0/aps_powerlaw.m:686
            else:
                debug_fig_linear=0
# Trainmatlab.v.0/aps_powerlaw.m:688
...
# Trainmatlab.v.0/aps_powerlaw.m:702
                K_tropo_powerlaw_bands[:,ix_interferogram,:]=K_band
# Trainmatlab.v.0/aps_powerlaw.m:703
...
# Trainmatlab.v.0/aps_powerlaw.m:745
        K_tropo_powerlaw_or=copy(K_tropo_powerlaw)
# Trainmatlab.v.0/aps_powerlaw.m:746
        if strcmp(stamps_processed,'y'):
            # This is StaMPS
            if strcmp(getparm('small_baseline_flag'),'y'):
    ...
    if start_step <= 5 and end_step >= 5 and exist('aps_RMSE_comparison') == 2:
        ...
        if strcmpi(getparm_aps('stamps_processed'),'y'):
            ...
            technique_number=- 10
# Trainmatlab.v.0/aps_powerlaw.m:807
...
# Trainmatlab.v.0/aps_powerlaw.m:809
                technique_number=floor(str2num(technique_number))
# Trainmatlab.v.0/aps_powerlaw.m:810

            # the technique component as a string
            if technique_number == 1:
                comp_str='a_mi'
# Trainmatlab.v.0/aps_powerlaw.m:814
            else:
                if technique_number == 2:
                    comp_str='a_MI'
# Trainmatlab.v.0/aps_powerlaw.m:816
                else:
                    if technique_number == 3:
                        comp_str='a_RMI'
# Trainmatlab.v.0/aps_powerlaw.m:818
                    else:
                        if technique_number == 4:
                            comp_str='a_e'
# Trainmatlab.v.0/aps_powerlaw.m:820
                        else:
                            if technique_number == 5:
                                comp_str='a_w'
# Trainmatlab.v.0/aps_powerlaw.m:822
                            else:
                                if technique_number == 6:
                                    if strcmpi(getparm('small_baseline_flag'),'y'):
                                        comp_str='usb'
# Trainmatlab.v.0/aps_powerlaw.m:825
                                    else:
                                        comp_str='u'
# Trainmatlab.v.0/aps_powerlaw.m:827
                                else:
                                    if technique_number == 7:
                                        if strcmpi(getparm('small_baseline_flag'),'y'):
                                            comp_str='usb-d'
# Trainmatlab.v.0/aps_powerlaw.m:831
                                        else:
                                            comp_str='u-d'
# Trainmatlab.v.0/aps_powerlaw.m:833
        ...
        # possible
            if technique_number == logical_or(1,technique_number) == logical_or(2,technique_number) == 3:
                hydro_comp=copy(inf)
# Trainmatlab.v.0/aps_powerlaw.m:840
...
# Trainmatlab.v.0/aps_powerlaw.m:870
                    bandnumber=str2num(bandnumber)
# Trainmatlab.v.0/aps_powerlaw.m:871
                    if isempty(bandnumber):
                        bandnumber=- 10
# Trainmatlab.v.0/aps_powerlaw.m:873
