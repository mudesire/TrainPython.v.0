...
# matlab/aps_meris_SAR.m:80
    smpres=getparm_aps('region_res')
# matlab/aps_meris_SAR.m:81
    
    xlims=getparm_aps('region_lon_range')
# matlab/aps_meris_SAR.m:83
    ylims=getparm_aps('region_lat_range')
# matlab/aps_meris_SAR.m:84
    dryconversion=0.23
# matlab/aps_meris_SAR.m:85
    wetdry=1
# matlab/aps_meris_SAR.m:86
    
    ## the actual scripting
#bounds for all ifgms in degrees or in meters
    xmin=xlims[1]
# matlab/aps_meris_SAR.m:92
    xmax=xlims[2]
# matlab/aps_meris_SAR.m:93
    ymin=ylims[1]
# matlab/aps_meris_SAR.m:94
    ymax=ylims[2]
# matlab/aps_meris_SAR.m:95
...
# matlab/aps_meris_SAR.m:174
        #into matrix mask
        cloud=bin2dec(flagbin[:,2])
# matlab/aps_meris_SAR.m:178
        cloudmat=reshape(cloud,mer_rows,mer_cols)
# matlab/aps_meris_SAR.m:179
        cloudmat[cloudmat == 1]=NaN
# matlab/aps_meris_SAR.m:180
        # NaNs will penetrate through the stack
        pconf=bin2dec(flagbin[:,23])
# matlab/aps_meris_SAR.m:184
        pconfmat=reshape(pconf,mer_rows,mer_cols)
# matlab/aps_meris_SAR.m:185
        pconfmat[pconfmat == 1]=NaN
# matlab/aps_meris_SAR.m:186
        lowp=bin2dec(flagbin[:,24])
# matlab/aps_meris_SAR.m:188
        lowpmat=reshape(lowp,mer_rows,mer_cols)
# matlab/aps_meris_SAR.m:189
        lowpmat[lowpmat == 1]=NaN
# matlab/aps_meris_SAR.m:190
        maskmat=multiply(multiply(cloudmat,pconfmat),lowpmat)
# matlab/aps_meris_SAR.m:193
        maskmat[isnan(maskmat)]=1
# matlab/aps_meris_SAR.m:194
        se=strel('square',3)
# matlab/aps_meris_SAR.m:197
        maskmat=imdilate(maskmat,se)
# matlab/aps_meris_SAR.m:198
        maskmat[maskmat == 1]=NaN
# matlab/aps_meris_SAR.m:200
        maskmat[maskmat == 0]=1
# matlab/aps_meris_SAR.m:201
        watervap=meris[:,:,14]
# matlab/aps_meris_SAR.m:204
        watervap=watervap / cosd(meris[:,:,42])
# matlab/aps_meris_SAR.m:206
        watervap=multiply(watervap,conversion)
# matlab/aps_meris_SAR.m:208
        corwatervap=multiply(watervap,maskmat)
# matlab/aps_meris_SAR.m:210
        #         ### aditonal masking
#         # water mask
...
#         clear outlier_mask water maskmat
        fid=fopen('out.bin','w')
# matlab/aps_meris_SAR.m:239
        corwatervap=corwatervap.T
# matlab/aps_meris_SAR.m:240
...
# matlab/aps_meris_SAR.m:246
        a,b=system(xyz2grd_cmd,nargout=2)
# matlab/aps_meris_SAR.m:247
...
# matlab/aps_meris_SAR.m:261
        a,b=system(grdfil_cmd,nargout=2)
# matlab/aps_meris_SAR.m:262
        #nointerp
...
# matlab/aps_meris_SAR.m:277
        a,b=system(grdsmp_cmd,nargout=2)
# matlab/aps_meris_SAR.m:278
...
# matlab/aps_meris_SAR.m:325
            fid=fopen('out.bin','w')
# matlab/aps_meris_SAR.m:326
            fwrite(fid,incidence,'real*4')
            fclose(fid)
            xyz2grd_cmd=matlabarray(cat('xyz2grd -R',num2str(mer_xmin),'/',num2str(mer_xmax),'/',num2str(mer_ymin),'/',num2str(mer_ymax),' -I',num2str(mer_cols),'+/',num2str(mer_rows),'+ out.bin -Gtmp.grd  -F -ZTLf'))
# matlab/aps_meris_SAR.m:330
            a,b=system(xyz2grd_cmd,nargout=2)
# matlab/aps_meris_SAR.m:331
            grdsmp_cmd=matlabarray(cat('grdsample -R',num2str(xmin),'/',num2str(xmax),'/',num2str(ymin),'/',num2str(ymax),' -I',num2str(smpres),' tmp.grd -Gtmp_smp.grd'))
# matlab/aps_meris_SAR.m:332
            a,b=system(grdsmp_cmd,nargout=2)
# matlab/aps_meris_SAR.m:333
            grd2xyz_cmd=matlabarray(cat('grd2xyz -R',num2str(xmin),'/',num2str(xmax),'/',num2str(ymin),'/',num2str(ymax),' tmp_smp.grd -bo > incidence.xyz'))
# matlab/aps_meris_SAR.m:334
            a,b=system(grd2xyz_cmd,nargout=2)
# matlab/aps_meris_SAR.m:335
