...
# Trainmatlab.v.0/aps_powerlaw_update_band.m
...
# Trainmatlab.v.0/aps_powerlaw_update_band.m:25
    if strcmp(stamps_processed,'y'):
        load(psver)
    else:
        psver=2
# Trainmatlab.v.0/aps_powerlaw_update_band.m:30
    
    save_path=matlabarray(cat(pwd,filesep))
# Trainmatlab.v.0/aps_powerlaw_update_band.m:33
    # file names of the output data
    apsname=matlabarray(cat(save_path,filesep,'tca',num2str(psver),'.mat'))
# Trainmatlab.v.0/aps_powerlaw_update_band.m:36
    apssbname=matlabarray(cat(save_path,filesep,'tca_sb',num2str(psver),'.mat'))
# Trainmatlab.v.0/aps_powerlaw_update_band.m:37
    apsbandsname=matlabarray(cat(save_path,filesep,'tca_bands',num2str(psver),'.mat'))
# Trainmatlab.v.0/aps_powerlaw_update_band.m:38
    apsbandssbname=matlabarray(cat(save_path,filesep,'tca_bands_sb',num2str(psver),'.mat'))
# Trainmatlab.v.0/aps_powerlaw_update_band.m:39
    # loading the data variable
    if strcmp(stamps_processed,'y'):
        if strcmp(getparm('small_baseline_flag'),'y'):
            aps_file=copy(apssbname)
# Trainmatlab.v.0/aps_powerlaw_update_band.m:46
            aps_band_file=copy(apsbandssbname)
# Trainmatlab.v.0/aps_powerlaw_update_band.m:47
        else:
            aps_file=copy(apsname)
# Trainmatlab.v.0/aps_powerlaw_update_band.m:49
            aps_band_file=copy(apsbandsname)
# Trainmatlab.v.0/aps_powerlaw_update_band.m:50
    else:
        aps_file=copy(apsname)
# Trainmatlab.v.0/aps_powerlaw_update_band.m:53
        aps_band_file=copy(apsbandsname)
# Trainmatlab.v.0/aps_powerlaw_update_band.m:54
...
# Trainmatlab.v.0/aps_powerlaw_update_band.m:61
        ph_tropo_powerlaw=copy(ph_tropo_powerlaw_or)
# Trainmatlab.v.0/aps_powerlaw_update_band.m:62
...
# Trainmatlab.v.0/aps_powerlaw_update_band.m:65
        ph_tropo_powerlaw=ph_tropo_powerlaw_bands(arange(),arange(),band_number)
# Trainmatlab.v.0/aps_powerlaw_update_band.m:66
        sptial_bands=getparm_aps('powerlaw_spatial_bands')
# Trainmatlab.v.0/aps_powerlaw_update_band.m:67
