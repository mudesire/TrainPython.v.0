...
# Trainmatlab.v.0/rotatelocal2ll.m
...
#
    ...
    plot_flag=0
# Trainmatlab.v.0/rotatelocal2ll.m:41
    if nargin < 3:
...
# Trainmatlab.v.0/rotatelocal2ll.m:60
    # performing the rotation of the data
    xy_local=(numpy.linalg.solve(Rotation_matrix,xy_rotatelocal)).T
# Trainmatlab.v.0/rotatelocal2ll.m:63
    # converting to geo-coordiantes
    ll=local2llh(xy_local.T,origin)
# Trainmatlab.v.0/rotatelocal2ll.m:66
    ll=ll.T
# Trainmatlab.v.0/rotatelocal2ll.m:67
    if plot_flag == 1:
        xy_rotatelocal=xy_rotatelocal.T
# Trainmatlab.v.0/rotatelocal2ll.m:71
