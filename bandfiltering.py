...
# figure properties
    fontsize=15
# matlab/bandfiltering.m:56
    plot_figures=0
# matlab/bandfiltering.m:57
    
    save_fig=0
# matlab/bandfiltering.m:58
    
    n_plot_dataset=1
# matlab/bandfiltering.m:59
    
    # Topography is first then the interferograms
    check_flag=0
# matlab/bandfiltering.m:61
    
    mirror_flag=1
# matlab/bandfiltering.m:62
    
    # are reduced. The mirror is based on the
                            # largest spatial filter wavelength.
    
    max_perc_mirror_2D=100
# matlab/bandfiltering.m:66
...
# matlab/bandfiltering.m:102
    ...
    norm_filter_flag=0
# matlab/bandfiltering.m:110
    n_degree_butterworth=10
# matlab/bandfiltering.m:111
    # number of datasets
    n_datasets=size(z_grid,3)
# matlab/bandfiltering.m:113
    n_band_filters=size(spatial_bands,1)
# matlab/bandfiltering.m:114
    if strcmp(ifg_based_correction,'y'):
        h_ifg_number=n_datasets / 2
# matlab/bandfiltering.m:116
    else:
        h_ifg_number=1
# matlab/bandfiltering.m:118
...
# matlab/bandfiltering.m:169
        data_columns_or=size(z_grid,2)
# matlab/bandfiltering.m:170
...
# matlab/bandfiltering.m:223
            if x_n_cases > y_n_cases:
                ...
                new_linestr=repmat('\\n',length(ix_x),1)
# matlab/bandfiltering.m:227
                outputstr=matlabarray(cat(num2str(spatial_bands[ix_x,:]),new_linestr))
# matlab/bandfiltering.m:228
                for kk in arange(1,size(outputstr,1)).reshape(-1):
                    fprintf(outputstr[kk,:])
                # setting the variables for the 1D filtering
                filter_1D_Y=1
# matlab/bandfiltering.m:234
                filter_1D_X=0
# matlab/bandfiltering.m:235
                ix_1D_filter=copy(ix_x)
# matlab/bandfiltering.m:236
                ...
                if y_n_cases > x_n_cases:
                    ...
                    new_linestr=repmat('\\n',length(ix_y),1)
# matlab/bandfiltering.m:242
                    outputstr=matlabarray(cat(num2str(spatial_bands[ix_y,:]),new_linestr))
# matlab/bandfiltering.m:243
                    for kk in arange(1,size(outputstr,1)).reshape(-1):
                        fprintf(outputstr[kk,:])
                    # setting the variables for the 1D filtering
                    filter_1D_Y=0
# matlab/bandfiltering.m:249
                    filter_1D_X=1
# matlab/bandfiltering.m:250
                    ix_1D_filter=copy(ix_y)
# matlab/bandfiltering.m:251
                    ...
                    new_linestr=repmat('\\n',length(ix_y),1)
# matlab/bandfiltering.m:257
                    outputstr=matlabarray(cat(num2str(spatial_bands[ix_y,:]),new_linestr))
# matlab/bandfiltering.m:258
                    for kk in arange(1,size(outputstr,1)).reshape(-1):
                        fprintf(outputstr[kk,:])
                    # setting the variables for the 1D filtering
                    filter_1D_Y=0
# matlab/bandfiltering.m:264
                    filter_1D_X=0
# matlab/bandfiltering.m:265
                    ix_1D_filter=matlabarray([])
# matlab/bandfiltering.m:266
                    clear('outputstr','new_linestr','kk','ix_x','ix_y')
        else:
            filter_1D_Y=0
# matlab/bandfiltering.m:270
            filter_1D_X=0
# matlab/bandfiltering.m:271
            ix_1D_filter=matlabarray([])
# matlab/bandfiltering.m:272
        if plot_figures == 1:
            data_original_image=z_grid[:,:,n_plot_dataset]
# matlab/bandfiltering.m:277
...
# matlab/bandfiltering.m:324
        data_columns=size(z_grid,2)
# matlab/bandfiltering.m:325
        fs_rows=1 / y_res
# matlab/bandfiltering.m:328
        fs_columns=1 / x_res
# matlab/bandfiltering.m:329
...
# matlab/bandfiltering.m:349
            Y_lims_fig_sym=matlabarray(cat(0,dot(data_rows,y_res)))
# matlab/bandfiltering.m:350
...
# matlab/bandfiltering.m:480
            dimension_filter=NaN(cat(n_band_filters,1))
# matlab/bandfiltering.m:481
...
# matlab/bandfiltering.m:644
                clear('data_band')
            if k <= h_ifg_number and h_ifg_number != 1:
                # thse are interferograms
                save_name=matlabarray(cat('bandfilter_regular_hgt_ifg_',num2str(k),'.mat'))
# matlab/bandfiltering.m:652
            else:
                if k <= h_ifg_number and h_ifg_number == 1:
                    # these are the heights
                    save_name='bandfilter_regular_hgt.mat'
# matlab/bandfiltering.m:655
                else:
                    # thse are interferograms
                    save_name=matlabarray(cat('bandfilter_regular_ifg_',num2str(k - h_ifg_number),'.mat'))
# matlab/bandfiltering.m:658
