...
# Trainmatlab.v.0/load_meris_SAR.m
...
#     51 Franklin Street, Fifth Floor, Boston, MA 02110-1301 USA.
    ...
    plot_flag=0
# Trainmatlab.v.0/load_meris_SAR.m:43
    if nargin < 1:
        error('myApp:argChk',cat('Not enough input arguments...\\n'))
    
    if nargin < 2 or isempty(xy_out_grid):
        interpolate_flag=0
# Trainmatlab.v.0/load_meris_SAR.m:51
    else:
        interpolate_flag=1
# Trainmatlab.v.0/load_meris_SAR.m:53
    
    if nargin < 3 or isempty(poly_crop_filename):
        crop_flag=0
# Trainmatlab.v.0/load_meris_SAR.m:57
    else:
        crop_flag=1
# Trainmatlab.v.0/load_meris_SAR.m:59
    
    ## Loading of meris processed data files
    fid=fopen(filename,'r')
# Trainmatlab.v.0/load_meris_SAR.m:64
    data_vector=fread(fid,'double')
# Trainmatlab.v.0/load_meris_SAR.m:65
    fclose(fid)
    # reshaping into the right 3 column matrix
    xyz_input=reshape(data_vector,3,[]).T
# Trainmatlab.v.0/load_meris_SAR.m:69
    clear('data_vector')
...
# Trainmatlab.v.0/load_meris_SAR.m:112
    else:
        if plot_flag == 1:
