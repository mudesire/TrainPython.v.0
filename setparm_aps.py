...
# matlab/setparm_aps.m:22
    localparmfile='localparms_aps.mat'
# matlab/setparm_aps.m:23
    parent_flag=0
# matlab/setparm_aps.m:25
    ...
    if exist(cat('.',filesep,parmfile),'file'):
        parms=load(parmfile)
# matlab/setparm_aps.m:32
    else:
        if exist(cat('..',filesep,parmfile),'file'):
            parmfile=matlabarray(cat('..',filesep,parmfile))
# matlab/setparm_aps.m:34
            parms=load(parmfile)
# matlab/setparm_aps.m:35
            parent_flag=1
# matlab/setparm_aps.m:36
    
    if exist(localparmfile,'file'):
        localparms=load(localparmfile)
# matlab/setparm_aps.m:40
    else:
        localparms=struct('Created',date)
# matlab/setparm_aps.m:42
...
# matlab/setparm_aps.m:109
                            ...
                            if size(value,1) > 1:
                                value_str='['
# matlab/setparm_aps.m:121
                                for ll in arange(1,size(value,1)).reshape(-1):
                                    if ll == size(value,1):
                                        value_str=matlabarray(cat(value_str,num2str(value[ll,:])))
# matlab/setparm_aps.m:124
                                    else:
                                        value_str=matlabarray(cat(value_str,num2str(value[ll,:]),'; '))
# matlab/setparm_aps.m:126
                                value_str=matlabarray(cat(value_str,']'))
# matlab/setparm_aps.m:129
                            else:
                                value_str=num2str(value)
# matlab/setparm_aps.m:131
                            logit(cat(parmname,' = ',value_str),'aps.log',parent_flag)
                            clear('value_str')
                        else:
                            if size(value,1) > 1:
                                value_str='['
# matlab/setparm_aps.m:137
                                for ll in arange(1,size(value,1)).reshape(-1):
                                    if ll == size(value,1):
                                        value_str=matlabarray(cat(value_str,num2str(value[ll,:])))
# matlab/setparm_aps.m:140
                                    else:
                                        value_str=matlabarray(cat(value_str,num2str(value[ll,:]),'; '))
# matlab/setparm_aps.m:142
                                value_str=matlabarray(cat(value_str,']'))
# matlab/setparm_aps.m:145
                            else:
...
# matlab/setparm_aps.m:173
                    ...
                    if logical_not(isfield(localparms,parmname)):
                        parms=setfield(parms,parmname,value)
# matlab/setparm_aps.m:186
                        save(parmfile,'-struct','parms')
                    else:
                        localparms=setfield(localparms,parmname,value)
# matlab/setparm_aps.m:189
                        save(localparmfile,'-struct','localparms')
