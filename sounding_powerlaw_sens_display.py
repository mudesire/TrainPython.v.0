...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m
...
#               for delay reference height difference
    ...
    colorbarflag=0
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:30
    fig_format='png'
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:31
    
    xlims=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:32
    
    curdir=copy(pwd)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:33
    fontsize=24
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:37
    # getting the data from the parms_aps file
    sounding_dir=getparm_aps('sounding_dir')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:39
    n_months=getparm_aps('sounding_months')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:40
    sounding_start_date=getparm_aps('sounding_start_date')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:41
    sounding_end_date=getparm_aps('sounding_end_date')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:42
    sounding_dir=getparm_aps('sounding_dir')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:43
    time_stamp=getparm_aps('sounding_time_stamp')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:44
    sounding_ifg_dates=getparm_aps('sounding_ifg_dates')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:45
    time_stamp_str=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:46
    for k in arange(1,size(time_stamp,1)).reshape(-1):
        if k > 1:
            time_stamp_str=matlabarray(cat(time_stamp_str,'_',time_stamp[k,:]))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:49
        else:
            time_stamp_str=matlabarray(cat(time_stamp[k,:]))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:51
    
    # saving of the figures
    save_str=matlabarray(cat(sounding_dir,filesep,'Powerlaw',filesep,'figures',filesep))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:56
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:62
        n_months=1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:63
        save_str=matlabarray(cat(save_str,'SAR_dates'))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:64
        stamps_processed=getparm_aps('stamps_processed')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:67
        if strcmp(stamps_processed,'y'):
            fprintf('Stamps processed structure \\n')
            ll_matfile=getparm_aps('ll_matfile')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:71
            ps=load(ll_matfile)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:72
            # constructing the matrix with master and slave dates
            if strcmp(getparm('small_baseline_flag'),'y'):
                # for SB
                ifgs_ix=ps.ifgday_ix
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:78
            else:
                n_ifg=ps.n_ifg
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:81
                date_slave_ix=cat(arange(1,n_ifg)).T
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:83
                date_master_ix=repmat(ps.master_ix,size(date_slave_ix,1),1)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:85
                ifgs_ix=matlabarray(cat(date_master_ix,date_slave_ix))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:87
        else:
            # getting the dates in jullian format
            ifgday_matfile=getparm_aps('ifgday_matfile')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:91
            ifgs_dates=load(ifgday_matfile)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:92
            ifgs_dates=ifgs_dates.ifgday
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:93
            dates=reshape(ifgs_dates,[],1)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:94
            dates=unique(dates)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:95
            dates=datenum(num2str(dates),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:96
            dates=sort(dates)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:97
            # getting the ix position for the master and slave dates with respect
        # to the times
            date_master=datenum(num2str(ifgs_dates[:,1]),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:101
            date_slave=datenum(num2str(ifgs_dates[:,2]),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:102
            for k in arange(1,size(date_master,1)).reshape(-1):
                date_master_ix[k,1]=find(date_master[k,1] == dates)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:105
                date_slave_ix[k,1]=find(date_slave[k,1] == dates)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:106
            # ix interferograms
            ifgs_ix=matlabarray(cat(date_master_ix,date_slave_ix))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:110
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:118
        end_year=str2num(sounding_end_date[1:4])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:119
        start_str=sounding_start_date[5:6]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:120
        end_str=sounding_end_date[5:6]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:121
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:124
        save_str=matlabarray(cat(save_str,'period_'))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:125
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:136
        h0_SAR=matlabarray(cat(h0_vector_fix(ifgs_ix[:,1]),h0_vector_fix(ifgs_ix[:,2])))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:137
        h0_InSAR=mean(h0_SAR,2)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:141
        alpha_InSAR=mean(alpha_SAR,2)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:142
        setparm_aps('powerlaw_h0',h0_InSAR.T)
        setparm_aps('powerlaw_alpha',alpha_InSAR.T)
    else:
        # computing the mean between two SAR dates
        ix=isnan(h0_vector)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:148
        powerlaw_h0=mean(h0_vector(logical_not(ix)))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:149
        powerlaw_alpha=mean(alpha_vector(logical_not(ix)))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:150
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:159
    # color variation
    color_max=dot(dot(n_months,30),size(time_stamp,1))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:162
    color_step=5
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:163
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:167
    
    if isempty(color_step):
        color_step=1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:170
    
    color_max=dot(ceil(color_max / color_step),color_step)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:173
    n_colors=color_max / color_step
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:174
    colorcode=jet(n_colors)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:177
    color_ix=floor(dot(n_soundings_vector / color_max,n_colors))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:178
    color_ix[color_ix == 0]=1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:179
    if isempty(xlims) != 1:
        xlimits=matlabarray(cat(datenum(num2str(xlims[1]),'yyyymmdd'),datenum(num2str(xlims[2]),'yyyymmdd')))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:182
        window_size=matlabarray(cat(64,254,1493,269))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:183
    else:
        window_size=matlabarray(cat(64,254,1493,269))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:185
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:192
    ...
    if colorbarflag == 1:
        cc=copy(colorbar)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:211
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:227
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:230
            if colorbarflag == 1:
                set(h,'Markerfacecolor',colorcode[color_ix[k],:])
            else:
                set(h,'Markerfacecolor','k')
    ...
    if colorbarflag == 1:
        cc=copy(colorbar)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:248
        caxis(cat(0,color_max))
        title(cc,'n soundings','fontsize',fontsize)
        colormap(jet(n_colors))
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:267
    ...
    if colorbarflag == 1:
        cc=copy(colorbar)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:286
        caxis(cat(0,color_max))
        title(cc,'n soundings','fontsize',fontsize)
        colormap(jet(n_colors))
    ...
    str=''
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:304
    while strcmpi(str,'y') != 1 and strcmpi(str,'n') != 1:

        str=input_(cat('Do you want to plot mean delay and net delay? [y/n] \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:306
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:310
        end_date_user=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:311
        while isempty(start_date_user):

            start_date_user=input_(cat('start date yyyymmdd (as a number or NaN for all)?  \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:313
            start_date_user=str2num(start_date_user)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:314

        while isempty(end_date_user):

            end_date_user=input_(cat('end date yyyymmdd (as a number or NaN for all)?  \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:317
            end_date_user=str2num(end_date_user)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:318

        if isnan(start_date_user):
            start_date_user=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:321
        else:
            start_date_user=num2str(start_date_user)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:323
        if isnan(end_date_user):
            end_date_user=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:326
        else:
            end_date_user=num2str(end_date_user)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:328
        time_stamp=getparm_aps('sounding_time_stamp')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:332
        cd(sounding_dir)
        # making a list of all the sounding files
        dummy,dummy2=system('echo sounding_list > sounding.list',nargout=2)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:336
        clear('dummy')
        clear('dummy2')
        for k in arange(1,size(time_stamp,1)).reshape(-1):
            command_str=matlabarray(cat('ls [0-9]???????_',time_stamp[k,:],'.mat >> sounding.list'))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:339
            dummy,dummy2=system(command_str,nargout=2)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:340
            clear('dummy')
            clear('dummy2')
        temp=tdfread('sounding.list')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:344
        dummy,dummy2=system('rm sounding.list',nargout=2)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:345
        clear('dummy')
        clear('dummy2')
        date_list_temp=temp.sounding_list(arange(),cat(arange(1,8)))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:347
        sounding_list=temp.sounding_list
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:348
        clear('ix')
        abord_flag=0
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:352
        count_runs=0
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:353
        while abord_flag == 0:
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:356
            else:
                if isempty(start_date_user) != 1 and isempty(end_date_user) == 1:
                    ix=find(datenum(date_list_temp,'yyyymmdd') >= datenum(start_date_user,'yyyymmdd'))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:358
                else:
                    if isempty(start_date_user) == 1 and isempty(end_date_user) != 1:
                        ix=find(datenum(date_list_temp,'yyyymmdd') <= datenum(end_date_user,'yyyymmdd'))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:360
            if isempty(start_date_user) != 1 or isempty(end_date_user) != 1:
                if isempty(ix) != 1:
                    date_list_temp=date_list_temp[ix,:]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:366
                    sounding_list=sounding_list[ix,:]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:367
                else:
                    fprintf('No sounding has been acquired in this period \\n')
                    continue_flag=0
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:370
                    abord_flag=1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:371
                clear('temp','ix')
            # getting the maximum height
            hgt_temp=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:377
            for counter_date in arange(1,size(sounding_list,1)).reshape(-1):
                # loading of the data
                temp=load(sounding_list[counter_date,:])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:380
                if isfield(temp,'h_delay'):
                    hgt_temp=matlabarray(cat([hgt_temp],[nanmax(temp.h_delay)]))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:382
                clear('temp')
            hgt_temp=sort(hgt_temp)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:386
            max_height_95=hgt_temp[floor(dot(length(hgt_temp),0.25))]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:387
            max_height_all=max(hgt_temp)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:388
            if sum(hgt_temp < max_height_all) > sum(hgt_temp < max_height_95):
                max_height=copy(max_height_95)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:391
            else:
                max_height=copy(max_height_all)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:393
            if count_runs == 0:
                # max_height = 15000;
                height_step=50
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:398
                max_delay=200
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:399
                delay_step=0.25
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:400
                max_sat_delay=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:401
                max_sat_netdelay=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:402
                scaling_resolution=1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:403
            else:
                # max_height = 15000;
                height_step=dot(50.0,scaling_resolution)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:406
                max_delay=200
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:407
                delay_step=multiply(0.25,scaling_resolution)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:408
                str=''
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:409
                while strcmpi(str,'y') != 1 and strcmpi(str,'n') != 1:

                    str=input_(cat('Are you happy with the color scale or do you want to change manually (y for re-run)? [y/n] \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:411

                abord_flags=0
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:413
                if strcmpi(str,'n'):
                    abord_flags=abord_flags + 1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:415
                else:
                    h_temp1=figure('name','color counts')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:417
                    subplot(2,1,1)
                    ...
                    str=''
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:425
                    while isnumeric(str) != 1:

                        str=input_(cat('change max saturation for the delay? [] for no change or numeric value \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:427
                        str=str2num(str)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:428

                    max_sat_delay=copy(str)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:430
                    str=''
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:431
                    while isnumeric(str) != 1:

                        str=input_(cat('change max saturation for the netdelay? [] for no change or numeric value \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:433
                        str=str2num(str)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:434

                    max_sat_netdelay=copy(str)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:436
                while strcmpi(str,'y') != 1 and strcmpi(str,'n') != 1:

                    str=input_(cat('Are you happy with the resolution or do you want to change manually (y for re-run)? [y/n] \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:441

                if strcmpi(str,'n'):
                    abord_flags=abord_flags + 1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:444
                else:
                    # changing the saturation values
                    str=''
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:447
                    while isnumeric(str) != 1:

                        str=input_(cat('By what scaling do you want to increase (new = factor*original resolution)? [] for no change or numeric value \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:449
                        str=str2num(str)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:450

                    scaling_resolution=copy(str)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:452
                    height_step=multiply(height_step,scaling_resolution)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:453
                    delay_step=multiply(delay_step,scaling_resolution)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:454
                if abord_flags == 2:
                    abord_flag=1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:460
                    break
                close_(h_delay)
                close_(h_netdelay)
                close_(h_temp1)
            max_height=dot(ceil(max_height / height_step),height_step)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:472
            max_delay=dot(ceil(max_delay / delay_step),delay_step)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:473
            nx=matlabarray(cat(max_delay / delay_step + 1))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:477
            ny=matlabarray(cat(max_height / height_step + 1))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:478
            delay_matrix_count=zeros(cat(ny,nx))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:479
            # loading the data for plotting of the delay curves
            delay_keep=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:483
            hgt_keep=cat(arange(1,max_height)).T
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:484
            for counter_date in arange(1,size(sounding_list,1)).reshape(-1):
                # loading of the data
                data_temp=load(sounding_list[counter_date,:])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:488
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:531
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:537
            nx_max=max(find(sum(delay_matrix_count,1) != 0))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:540
            ny_max=max(find(sum(delay_matrix_count,2) != 0))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:541
            x_bounds=cat(dot(0(nx_max - 1),delay_step)) / 100
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:542
            y_bounds=cat(dot(0(ny_max - 1),height_step)) / 1000
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:543
            delay_matrix_count=delay_matrix_count[:,1:nx_max]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:546
            delay_matrix_count=delay_matrix_count[1:ny_max,:]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:547
            delay_matrix_count[delay_matrix_count == 0]=NaN
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:548
            h_delay=figure('name','Delay curve')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:550
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:558
            scale_axis=matlabarray(cat(dot(floor(scale_axis[1] / 1),1),dot(ceil(scale_axis[2] / 1),1)))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:559
            n_steps=(scale_axis[2] - scale_axis[1]) / 1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:560
            colormap_figure=(gray(ceil(dot(n_steps,1.15))))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:561
            colormap_figure=flipud(colormap_figure[1:n_steps,:])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:562
            colormap_figure=reshape(repmat(colormap_figure,1,10).T,3,[]).T
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:563
            colormap_figure=matlabarray(cat([1,1,1],[colormap_figure]))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:564
            ...
            n_netdelays_max=400
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:573
            n_soundings=size(delay_keep,2)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:574
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:577
                ix1_random=single(ix1_random)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:578
                ix2_random=ix1_random.T
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:579
                ix_temp=logical_and(logical(tril(ones(n_soundings))),logical_not(eye(n_soundings)))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:580
                ix_random=matlabarray(cat(ix1_random[ix_temp],ix2_random[ix_temp]))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:581
                clear('ix1_random','ix2_random')
            else:
                fprintf(cat('Take random set to make netdelay differences \\n'))
                # take 2 random sets of n_netdelays_max
                new_set_search=1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:586
                loop_counter=0
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:587
                while new_set_search:

                    ix1_random=ceil(dot(rand(dot(n_netdelays_max,5),1),n_soundings))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:589
                    ix2_random=ceil(dot(rand(dot(n_netdelays_max,5),1),n_soundings))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:590
                    ix_random=matlabarray(cat(ix1_random,ix2_random))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:591
                    clear('ix1_random','ix2_random')
                    # remove those net delays of the same date
                    ix_temp=find(ix_random[:,1] - ix_random[:,2] == 0)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:595
                    ix_random[ix_temp,:]=[]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:596
                    clear('ix_temp')
                    # remove repetition of pair combination
                    ix_random=unique(ix_random,'rows')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:600
                    if size(ix_random,1) >= n_netdelays_max:
                        ix_random[n_netdelays_max + 1:end(),:]=[]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:604
                        new_set_search=0
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:605
                    loop_counter=loop_counter + 1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:608
                    if loop_counter == 50:
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:617
            netdelay_matrix_temp=delay_keep[:,ix_random[:,1]] - delay_keep[:,ix_random[:,2]]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:618
            netdelay_matrix_count=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:622
            max_netdelay=25
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:623
            delay_step=delay_step / 2
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:624
            max_height=dot(ceil(max_height / height_step),height_step)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:626
            max_netdelay=dot(ceil(max_netdelay / delay_step),delay_step)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:627
            nx=matlabarray(cat(dot(2,max_netdelay) / delay_step + 2))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:630
            ny=matlabarray(cat(max_height / height_step + 1))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:631
            netdelay_matrix_count=zeros(cat(ny,nx))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:632
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:639
                for m in arange(1,length(data_temp)).reshape(-1):
                    if hgt_keep[m] <= max_height:
                        if logical_not(isnan(data_temp[m])):
                            iy_pos=round(hgt_keep[m] / height_step) + 1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:645
                            ix_pos=round(dot(data_temp[m],100.0) / delay_step) + 1 + nx / 2
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:646
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:648
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:661
            nx_min=min(find(sum(netdelay_matrix_count,1) != 0))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:662
            nx_max=nx / 2 + max(cat(nx_max - nx / 2,nx / 2 - nx_min))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:663
            nx_min=nx / 2 - max(cat(nx_max - nx / 2,nx / 2 - nx_min))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:664
            ny_max=max(find(sum(netdelay_matrix_count,2) != 0))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:665
            x_bounds=matlabarray(cat(dot(dot((nx_min - nx / 2 + 1),delay_step[nx_max - nx / 2 - 1]),delay_step)))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:666
            y_bounds=cat(dot(0(ny_max - 1),height_step)) / 1000
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:667
            if nx_min == 0:
                nx_min=1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:670
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:673
            netdelay_matrix_count=netdelay_matrix_count[1:ny_max,:]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:674
            netdelay_matrix_count[netdelay_matrix_count == 0]=NaN
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:675
            h_netdelay=figure('name','Net-delay curve')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:677
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:683
            scale_axis=matlabarray(cat(dot(floor(scale_axis[1] / 1),1),dot(ceil(scale_axis[2] / 1),1)))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:684
            n_steps=(scale_axis[2] - scale_axis[1]) / 1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:685
            colormap_figure=(gray(ceil(dot(n_steps,1.2))))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:686
            colormap_figure=flipud(colormap_figure[1:n_steps,:])
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:687
            colormap_figure=reshape(repmat(colormap_figure,1,10).T,3,[]).T
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:688
            colormap_figure=matlabarray(cat([1,1,1],[colormap_figure]))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:689
            colormap(colormap_figure)
            ylabel('h [km]','fontsize',fontsize)
            xlabel('\\Delta d_{tropo} [cm]','fontsize',fontsize)
            set(gca,'fontsize',fontsize)
            count_runs=count_runs + 1
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:695

        cd(curdir)
        # plotting the mean delay curve
        str=''
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:703
        while strcmpi(str,'y') != 1 and strcmpi(str,'n') != 1:

            str=input_(cat('Do you want to plot the loglog mean delay? [y/n] \\n'),'s')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:705

        if strcmpi(str,'y'):
            h0=getparm_aps('powerlaw_h0')
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:708
            h_lims=matlabarray(cat(0,4))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:710
            h_lims_scalled=sort((h0 - h_lims))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:711
            hgt_keep_new=copy(hgt_keep)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:713
            mean_delay_new=copy(mean_delay)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:714
            mean_delay_new[hgt_keep_new / 1000 < logical_or(min(h_lims),hgt_keep_new / 1000) >= max(h_lims)]=[]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:715
            hgt_keep_new[hgt_keep_new / 1000 < logical_or(min(h_lims),hgt_keep_new / 1000) >= max(h_lims)]=[]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:716
            h_scalled=(h0 - hgt_keep_new / 1000)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:717
            # line through data
            A=matlabarray(cat(log10(h_scalled),ones(size(h_scalled))))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:721
            coeff=lscov(A,log10(mean_delay_new))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:722
            y_values=dot(cat((sort(log10(h_lims_scalled))).T,cat([1],[1])),coeff)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:723
            # latter on
            h_temp=figure('position',cat(1000,392,560,530))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:727
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:740
            h_scalled_ticks=log10(h0 - h_ticks / 1000)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:741
            h_scalled_ticks_label=num2str(round(dot(h_ticks.T / 1000.0,10)) / 10)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:742
            h_scalled_ticks,b=sort(h_scalled_ticks,nargout=2)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:743
            h_scalled_ticks_label=h_scalled_ticks_label[b,:]
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:744
            Ax1=copy(gca)
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:745
            figure('position',cat(1000,392,560,530),'name','Power-law')
            Ax2=axes('Position',get(Ax1,'Position'))
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:750
            plot(log10(h_scalled),log10(mean_delay_new))
            xlim(sort(log10(h_lims_scalled)))
...
# Trainmatlab.v.0/sounding_powerlaw_sens_display.m:759
            hold('on')
