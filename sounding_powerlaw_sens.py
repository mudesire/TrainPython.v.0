...
# Trainmatlab.v.0/sounding_powerlaw_sens.m
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:49
    ...
    # current directry
    curdir=copy(pwd)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:58
    # getting the interferogram data information
# loading the data
    stamps_processed=getparm_aps('stamps_processed')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:62
    if strcmp(stamps_processed,'y'):
        fprintf('Stamps processed structure \\n')
        ll_matfile=getparm_aps('ll_matfile')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:65
        ps=load(ll_matfile)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:66
        dates=ps.day
# Trainmatlab.v.0/sounding_powerlaw_sens.m:67
        lonlat=ps.lonlat
# Trainmatlab.v.0/sounding_powerlaw_sens.m:68
        # constructing the matrix with master and slave dates
        if strcmp(getparm('small_baseline_flag'),'y'):
            # for SB
            ifgs_ix=ps.ifgday_ix
# Trainmatlab.v.0/sounding_powerlaw_sens.m:75
        else:
            n_ifg=ps.n_ifg
# Trainmatlab.v.0/sounding_powerlaw_sens.m:78
            date_slave_ix=cat(arange(1,n_ifg)).T
# Trainmatlab.v.0/sounding_powerlaw_sens.m:80
            date_master_ix=repmat(ps.master_ix,size(date_slave_ix,1),1)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:82
            ifgs_ix=matlabarray(cat(date_master_ix,date_slave_ix))
# Trainmatlab.v.0/sounding_powerlaw_sens.m:84
    else:
        # getting the dates in jullian format
        ifgday_matfile=getparm_aps('ifgday_matfile')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:88
        ifgs_dates=load(ifgday_matfile)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:89
        ifgs_dates=ifgs_dates.ifgday
# Trainmatlab.v.0/sounding_powerlaw_sens.m:90
        dates=reshape(ifgs_dates,[],1)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:91
        dates=unique(dates)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:92
        dates=datenum(num2str(dates),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:93
        dates=sort(dates)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:94
        # getting the ix position for the master and slave dates with respect
    # to the times
        date_master=datenum(num2str(ifgs_dates[:,1]),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:98
        date_slave=datenum(num2str(ifgs_dates[:,2]),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:99
        for k in arange(1,size(date_master,1)).reshape(-1):
            date_master_ix[k,1]=find(date_master[k,1] == dates)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:102
            date_slave_ix[k,1]=find(date_slave[k,1] == dates)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:103
        # ix interferograms
        ifgs_ix=matlabarray(cat(date_master_ix,date_slave_ix))
# Trainmatlab.v.0/sounding_powerlaw_sens.m:107
        clear('date_master_ix','date_slave_ix')
    
    if strcmp(sounding_ifg_dates,'y'):
        # estimate for interferogram dates
        stamps_processed=getparm_aps('stamps_processed')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:116
        if strcmp(stamps_processed,'y'):
            ps=load(ll_matfile)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:118
            date_start_vector=datestr(ps.day - 15,'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:119
            date_end_vector=datestr(ps.day + 15,'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:120
        else:
            ifgday_matfile=getparm_aps('ifgday_matfile')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:124
            ifgs_dates=load(ifgday_matfile)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:125
            ifgs_dates=ifgs_dates.ifgday
# Trainmatlab.v.0/sounding_powerlaw_sens.m:126
            dates=reshape(ifgs_dates,[],1)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:127
            dates=unique(dates)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:128
            dates=datenum(num2str(dates),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:129
            dates=sort(dates)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:130
            date_start_vector=datestr(dates - 15,'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:133
            date_end_vector=datestr(dates + 15,'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:134
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:157
                clear('dummy')
                clear('dummy2')
                for k in arange(1,size(time_stamp,1)).reshape(-1):
                    command_str=matlabarray(cat('ls [0-9]???????_',time_stamp[k,:],'.mat >> sounding.list'))
# Trainmatlab.v.0/sounding_powerlaw_sens.m:160
                    dummy,dummy2=system(command_str,nargout=2)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:161
                    clear('dummy')
                    clear('dummy2')
            temp=tdfread('sounding.list')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:165
            dummy,dummy2=system('rm sounding.list',nargout=2)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:166
            clear('dummy')
            clear('dummy2')
            date_list_temp=temp.sounding_list(arange(),cat(arange(1,8)))
# Trainmatlab.v.0/sounding_powerlaw_sens.m:168
            clear('ix')
            if isempty(start_date):
                sounding_start_date=date_list_temp[1,:]
# Trainmatlab.v.0/sounding_powerlaw_sens.m:174
            if isempty(end_date):
                sounding_end_date=date_list_temp[end(),:]
# Trainmatlab.v.0/sounding_powerlaw_sens.m:177
            clear('date_list_temp')
        # putting the variables in the right set-up
        start_year=str2num(sounding_start_date[1:4])
# Trainmatlab.v.0/sounding_powerlaw_sens.m:183
        end_year=str2num(sounding_end_date[1:4])
# Trainmatlab.v.0/sounding_powerlaw_sens.m:184
        start_str=sounding_start_date[5:6]
# Trainmatlab.v.0/sounding_powerlaw_sens.m:185
        end_str=sounding_end_date[5:6]
# Trainmatlab.v.0/sounding_powerlaw_sens.m:186
        start_month=str2num(start_str)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:187
        end_month=str2num(end_str)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:188
        if hydro == 1 and wet == 0:
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:192
        else:
            if hydro == 0 and wet == 1:
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:194
            else:
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:196
        if exist(cat(sounding_dir,filesep,'Powerlaw'),'dir') != 7:
            mkdir(cat(sounding_dir,filesep,'Powerlaw'))
        if exist(cat(sounding_dir,filesep,'Powerlaw'),'dir') != 7:
            mkdir(cat(sounding_dir,filesep,'Powerlaw'))
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:209
        counter=1
# Trainmatlab.v.0/sounding_powerlaw_sens.m:210
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:215
                    date_start_month_vector[counter,:]=datestr(date_start_temp,'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:216
                    counter=counter + 1
# Trainmatlab.v.0/sounding_powerlaw_sens.m:217
            else:
                if k == logical_and(end_year - start_year + 1,k) == 1:
                    for l in arange(start_month,end_month).reshape(-1):
                        date_start_temp=datenum(cat(num2str(start_year + k - 1),month_str[l,:],'01'),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:221
                        date_start_month_vector[counter,:]=datestr(date_start_temp,'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:222
                        counter=counter + 1
# Trainmatlab.v.0/sounding_powerlaw_sens.m:223
                else:
                    for l in arange(1,12).reshape(-1):
                        date_start_temp=datenum(cat(num2str(start_year + k - 1),month_str[l,:],'01'),'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:227
                        date_start_month_vector[counter,:]=datestr(date_start_temp,'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:228
                        counter=counter + 1
# Trainmatlab.v.0/sounding_powerlaw_sens.m:229
        n_months_total=size(date_start_month_vector,1)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:234
        for k in arange(1,ceil(n_months_total / n_months)).reshape(-1):
            k_lower=dot(n_months,(k - 1)) + 1
# Trainmatlab.v.0/sounding_powerlaw_sens.m:236
            k_upper=dot(n_months,(k)) + 1
# Trainmatlab.v.0/sounding_powerlaw_sens.m:237
            if k_upper > n_months_total:
                k_upper=copy(n_months_total)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:240
            date_start_vector[k,:]=date_start_month_vector[k_lower,:]
# Trainmatlab.v.0/sounding_powerlaw_sens.m:242
            date_end_vector[k,:]=datestr(datenum(date_start_month_vector[k_upper,:],'yyyymmdd') - 1,'yyyymmdd')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:243
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:250
    else:
        ix_drop=matlabarray([])
# Trainmatlab.v.0/sounding_powerlaw_sens.m:252
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:255
    
    ix_drop=unique(ix_drop)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:257
    date_end_vector[ix_drop,:]=[]
# Trainmatlab.v.0/sounding_powerlaw_sens.m:258
    date_start_vector[ix_drop,:]=[]
# Trainmatlab.v.0/sounding_powerlaw_sens.m:259
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:266
        alpha_vector_all[k,1]=alpha_all
# Trainmatlab.v.0/sounding_powerlaw_sens.m:267
        alpha_vector[k,1]=alpha_hc
# Trainmatlab.v.0/sounding_powerlaw_sens.m:268
        n_soundings_vector[k,1]=n_soundings
# Trainmatlab.v.0/sounding_powerlaw_sens.m:269
        h0_vector[k,1]=h_0_threshold
# Trainmatlab.v.0/sounding_powerlaw_sens.m:270
    ...
    if strcmp(sounding_ifg_dates,'y'):
        # estimate for interferogram dates
        stamps_processed=getparm_aps('stamps_processed')
# Trainmatlab.v.0/sounding_powerlaw_sens.m:278
        if strcmp(stamps_processed,'y'):
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:283
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:287
                    alpha_vector_fix=copy(alpha_vector)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:288
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:297
...
# Trainmatlab.v.0/sounding_powerlaw_sens.m:301
                    h0_vector_fix=copy(h0_vector)
# Trainmatlab.v.0/sounding_powerlaw_sens.m:302
