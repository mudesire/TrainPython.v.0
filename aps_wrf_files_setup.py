...
# Trainmatlab.v.0/aps_wrf_files_setup.m
...
# Trainmatlab.v.0/aps_wrf_files_setup.m:30
    
    # getting the variables from the parms_aps file
    stamps_processed=getparm_aps('stamps_processed')
# Trainmatlab.v.0/aps_wrf_files_setup.m:33
    ll_matfile=getparm_aps('ll_matfile')
# Trainmatlab.v.0/aps_wrf_files_setup.m:34
    UTC_sat=getparm_aps('UTC_sat')
# Trainmatlab.v.0/aps_wrf_files_setup.m:35
    t_spin_up='12:00'
# Trainmatlab.v.0/aps_wrf_files_setup.m:36
    
    data_intervals=6
# Trainmatlab.v.0/aps_wrf_files_setup.m:37
    
    if isempty(wrf_datapath):
        wrf_datapath=getparm_aps('wrf_datapath')
# Trainmatlab.v.0/aps_wrf_files_setup.m:40
    
    
    # loading the data
    if strcmp(stamps_processed,'y'):
        ps=load(ll_matfile)
# Trainmatlab.v.0/aps_wrf_files_setup.m:45
        dates=ps.day
# Trainmatlab.v.0/aps_wrf_files_setup.m:46
        load('psver')
        fprintf('Stamps processed structure \\n')
    else:
        psver=2
# Trainmatlab.v.0/aps_wrf_files_setup.m:50
        ifgday_matfile=getparm_aps('ifgday_matfile')
# Trainmatlab.v.0/aps_wrf_files_setup.m:51
        ifgs_dates=load(ifgday_matfile)
# Trainmatlab.v.0/aps_wrf_files_setup.m:52
        ifgs_dates=ifgs_dates.ifgday
# Trainmatlab.v.0/aps_wrf_files_setup.m:53
        dates=reshape(ifgs_dates,[],1)
# Trainmatlab.v.0/aps_wrf_files_setup.m:54
        dates=unique(dates)
# Trainmatlab.v.0/aps_wrf_files_setup.m:55
        dates=datenum(num2str(dates),'yyyymmdd')
# Trainmatlab.v.0/aps_wrf_files_setup.m:56
    
    t_SAR=str2num(UTC_sat[1:2]) + str2num(UTC_sat[4:5]) / 60
# Trainmatlab.v.0/aps_wrf_files_setup.m:58
    t_spin=str2num(t_spin_up[1:2]) + str2num(t_spin_up[4:5]) / 60
# Trainmatlab.v.0/aps_wrf_files_setup.m:59
...
# Trainmatlab.v.0/aps_wrf_files_setup.m:62
    t_start=t_SAR - t_spin
# Trainmatlab.v.0/aps_wrf_files_setup.m:63
    # getting the start date of the model
    if t_start < 0:
        n_days=floor(t_start / 24)
# Trainmatlab.v.0/aps_wrf_files_setup.m:67
        dates_model=dates - abs(n_days)
# Trainmatlab.v.0/aps_wrf_files_setup.m:68
        time_model=abs(dot(n_days,24)) - abs(t_start)
# Trainmatlab.v.0/aps_wrf_files_setup.m:69
    else:
        n_days=0
# Trainmatlab.v.0/aps_wrf_files_setup.m:71
        dates_model=copy(dates)
# Trainmatlab.v.0/aps_wrf_files_setup.m:72
        time_model=copy(t_start)
# Trainmatlab.v.0/aps_wrf_files_setup.m:73
    
    # gettign the start time of the model
    time_model_ix=floor(time_model / data_intervals)
# Trainmatlab.v.0/aps_wrf_files_setup.m:76
    time_model=dot(time_model_ix,data_intervals)
# Trainmatlab.v.0/aps_wrf_files_setup.m:77
    time_model=num2str(time_model)
# Trainmatlab.v.0/aps_wrf_files_setup.m:78
    if length(time_model) == 1:
        time_model=matlabarray(cat('0',time_model))
# Trainmatlab.v.0/aps_wrf_files_setup.m:80
    
    # getting the last required time of model data
    time_model_end=dot(ceil(t_SAR / data_intervals),data_intervals)
# Trainmatlab.v.0/aps_wrf_files_setup.m:84
    dates_model_end=copy(dates)
# Trainmatlab.v.0/aps_wrf_files_setup.m:85
    if time_model_end == 24:
        time_model_end=0
# Trainmatlab.v.0/aps_wrf_files_setup.m:87
        dates_model_end=dates_model_end + 1
# Trainmatlab.v.0/aps_wrf_files_setup.m:88
    
    time_model_end=num2str(time_model_end)
# Trainmatlab.v.0/aps_wrf_files_setup.m:90
    if length(time_model_end) == 1:
        time_model_end=matlabarray(cat('0',time_model_end))
# Trainmatlab.v.0/aps_wrf_files_setup.m:92
    
    # Download data for the period:
    GDAS_flag=0
# Trainmatlab.v.0/aps_wrf_files_setup.m:97
    GFS_flag=0
# Trainmatlab.v.0/aps_wrf_files_setup.m:98
    data_filename_GDAS_prev=matlabarray([])
# Trainmatlab.v.0/aps_wrf_files_setup.m:99
    data_filename_GDAS_prev2=matlabarray([])
# Trainmatlab.v.0/aps_wrf_files_setup.m:100
    # Download data for the period:
...
# Trainmatlab.v.0/aps_wrf_files_setup.m:130
            if GFSR_check < 0 and GDAS_flag == 0:
                GDAS_flag=1
# Trainmatlab.v.0/aps_wrf_files_setup.m:132
                mkdir(cat(wrf_datapath,filesep,'temp'))
            else:
                if GFSR_check >= 0 and GFS_flag == 0:
                    GFS_flag=1
# Trainmatlab.v.0/aps_wrf_files_setup.m:135
...
# Trainmatlab.v.0/aps_wrf_files_setup.m:184
...
# Trainmatlab.v.0/aps_wrf_files_setup.m:186
                        status,cmdout=system(command_str,nargout=2)
# Trainmatlab.v.0/aps_wrf_files_setup.m:187
...
# Trainmatlab.v.0/aps_wrf_files_setup.m:189
                        status,cmdout=system(command_str2,nargout=2)
# Trainmatlab.v.0/aps_wrf_files_setup.m:190
...
# Trainmatlab.v.0/aps_wrf_files_setup.m:197
                    if exist(cat(wrf_datapath,filesep,data_filename_GDAS2[6:end() - 3])):
                        command_str2=matlabarray(cat('tar -xvf ',wrf_datapath,filesep,data_filename_GDAS2[6:end() - 2],' -C ',wrf_datapath,filesep,'temp'))
# Trainmatlab.v.0/aps_wrf_files_setup.m:199
                        status,cmdout=system(command_str2,nargout=2)
# Trainmatlab.v.0/aps_wrf_files_setup.m:200
                        if exist(cat(wrf_datapath,filesep,data_filename_GDAS2[6:end() - 3]),'file') == 2:
                            movefile(cat(wrf_datapath,filesep,data_filename_GDAS2[6:end() - 3]),cat(wrf_datapath,filesep,'temp',filesep,'.'))
                data_time_str_new=datestr(datenum(data_time_str[1:end() - 2],'yyyymmdd_HH'),'yyyymmddHH')
# Trainmatlab.v.0/aps_wrf_files_setup.m:206
            ...
            # This is not required for GFS data
                if kk > 1:
                    skip_flag=0
# Trainmatlab.v.0/aps_wrf_files_setup.m:231
                else:
                    skip_flag=1
# Trainmatlab.v.0/aps_wrf_files_setup.m:233
                if skip_flag == 0:
