...
# matlab/grdinfo2.m:109
        dy=diff(yrange) / double(ny)
# matlab/grdinfo2.m:110
    else:
        dx=diff(xrange) / double(nx - 1)
# matlab/grdinfo2.m:112
        dy=diff(yrange) / double(ny - 1)
# matlab/grdinfo2.m:113
