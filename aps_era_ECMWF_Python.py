...
# DB    03/2014 Auto download included
    ...
    year=timing[1:4]
# matlab/aps_era_ECMWF_Python.m:30
    month=timing[5:6]
# matlab/aps_era_ECMWF_Python.m:31
    day=timing[7:8]
# matlab/aps_era_ECMWF_Python.m:32
    htime=timing[9:10]
# matlab/aps_era_ECMWF_Python.m:33
    #mfield = calendar(str2double(year),str2double(month));
#nday = max(max(mfield));
    datestr=matlabarray(cat(year,'-',month,'-',day))
# matlab/aps_era_ECMWF_Python.m:37
    pythonsc_path=matlabarray(cat(timing,'.py'))
# matlab/aps_era_ECMWF_Python.m:39
    fid=fopen(pythonsc_path,'w')
# matlab/aps_era_ECMWF_Python.m:40
