...
# matlab/aps_powerlaw_watershed.m
...
# matlab/aps_powerlaw_watershed.m:66
    deminfo.xmax = copy(xmax)
# matlab/aps_powerlaw_watershed.m:67
    deminfo.ymax = copy(ymax)
# matlab/aps_powerlaw_watershed.m:68
    deminfo.ymin = copy(ymin)
# matlab/aps_powerlaw_watershed.m:69
    deminfo.dem_smooth = copy(dem_smooth)
# matlab/aps_powerlaw_watershed.m:70
    hold('on')
    plot(lonlatfile.lonlat(ix_convexhull,1),lonlatfile.lonlat(ix_convexhull,2),'g-','linewidth',2)
    counter=1
# matlab/aps_powerlaw_watershed.m:77
    continue_flag=1
# matlab/aps_powerlaw_watershed.m:78
    while continue_flag:
...
# matlab/aps_powerlaw_watershed.m:86
        str=''
# matlab/aps_powerlaw_watershed.m:90
        while logical_not(strcmpi(str,'y')) and logical_not(strcmpi(str,'n')):

            str=input_('Is this a hard ridge? (y) yes, or (n) no \\n','s')
# matlab/aps_powerlaw_watershed.m:92

        if strcmpi(str,'y'):
            hard_ridge_flag[counter]=1
# matlab/aps_powerlaw_watershed.m:95
        else:
            hard_ridge_flag[counter]=0
# matlab/aps_powerlaw_watershed.m:97
...
# matlab/aps_powerlaw_watershed.m:118
            ...
            counter=counter + 1
# matlab/aps_powerlaw_watershed.m:129
