...
# Trainmatlab.v.0/aps_check_systemcall_error.m
...
# 02/2016   DB  Add and exception in case the modis data is empty.
    ...
    if system_call_argument1 != 0:
        ...
        error_flag=1
# Trainmatlab.v.0/aps_check_systemcall_error.m:29
        if strfind(system_call_argument2,'No datapoints'):
            error_flag=0
# Trainmatlab.v.0/aps_check_systemcall_error.m:33
        ...
        error_flag=copy(NaN)
# Trainmatlab.v.0/aps_check_systemcall_error.m:43
