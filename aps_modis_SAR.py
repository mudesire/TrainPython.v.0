...
# Trainmatlab.v.0/aps_modis_SAR.m
...
#bounds for all ifgms in degrees or in meters
    ...
    xmin=xlims[1]
# Trainmatlab.v.0/aps_modis_SAR.m:72
    xmax=xlims[2]
# Trainmatlab.v.0/aps_modis_SAR.m:73
    ymin=ylims[1]
# Trainmatlab.v.0/aps_modis_SAR.m:74
    ymax=ylims[2]
# Trainmatlab.v.0/aps_modis_SAR.m:75
...
# Trainmatlab.v.0/aps_modis_SAR.m:82
    ix_keep=matlabarray([])
# Trainmatlab.v.0/aps_modis_SAR.m:83
...
# Trainmatlab.v.0/aps_modis_SAR.m:88
                recal_str='_recal'
# Trainmatlab.v.0/aps_modis_SAR.m:89
        else:
            if isempty(strfind(files[counter,:],'recal')):
                ix_keep=matlabarray(cat([ix_keep],[counter]))
# Trainmatlab.v.0/aps_modis_SAR.m:93
                recal_str=''
# Trainmatlab.v.0/aps_modis_SAR.m:94
    
    files=files[ix_keep,:]
# Trainmatlab.v.0/aps_modis_SAR.m:99
    ndates=size(files,1)
# Trainmatlab.v.0/aps_modis_SAR.m:100
    # loading the date information
    if strcmp(stamps_processed,'y'):
        ps=load(getparm_aps('ll_matfile'))
# Trainmatlab.v.0/aps_modis_SAR.m:104
        ifgs_dates=ps.day
# Trainmatlab.v.0/aps_modis_SAR.m:105
        fprintf('Stamps processed structure \\n')
    else:
        ifgday_matfile=getparm_aps('ifgday_matfile',1)
# Trainmatlab.v.0/aps_modis_SAR.m:108
        ifgs_dates=load(ifgday_matfile)
# Trainmatlab.v.0/aps_modis_SAR.m:109
        ifgs_dates=ifgs_dates.ifgday
# Trainmatlab.v.0/aps_modis_SAR.m:110
        ifgs_dates=reshape(ifgs_dates,[],1)
# Trainmatlab.v.0/aps_modis_SAR.m:111
        ifgs_dates=unique(ifgs_dates)
# Trainmatlab.v.0/aps_modis_SAR.m:112
...
# Trainmatlab.v.0/aps_modis_SAR.m:166
        a,b=system(grdfil1_cmd,nargout=2)
# Trainmatlab.v.0/aps_modis_SAR.m:167
...
# Trainmatlab.v.0/aps_modis_SAR.m:170
        a,b=system(grd2xyz_cmd,nargout=2)
# Trainmatlab.v.0/aps_modis_SAR.m:171
...
# Trainmatlab.v.0/aps_modis_SAR.m:174
        a,b=system(grdfil_cmd,nargout=2)
# Trainmatlab.v.0/aps_modis_SAR.m:175
        #nointerp
...
# Trainmatlab.v.0/aps_modis_SAR.m:185
        a,b=system(grdsmp_cmd,nargout=2)
# Trainmatlab.v.0/aps_modis_SAR.m:186
        grd2xyz_cmd=matlabarray(cat('grd2xyz -R',num2str(xmin),'/',num2str(xmax),'/',num2str(ymin),'/',num2str(ymax),' tmp_smp2.grd -bo >',outfile_gauss))
# Trainmatlab.v.0/aps_modis_SAR.m:187
        a,b=system(grd2xyz_cmd,nargout=2)
# Trainmatlab.v.0/aps_modis_SAR.m:188
...
# Trainmatlab.v.0/aps_modis_SAR.m:190
        a,b=system(grdsmp_cmd,nargout=2)
# Trainmatlab.v.0/aps_modis_SAR.m:191
...
# Trainmatlab.v.0/aps_modis_SAR.m:192
        a,b=system(grd2xyz_cmd,nargout=2)
# Trainmatlab.v.0/aps_modis_SAR.m:193
        # opening the data file (not-interpolated)
        nointfid=fopen(outfile,'r')
# Trainmatlab.v.0/aps_modis_SAR.m:197
        data_vector=fread(nointfid,'double')
# Trainmatlab.v.0/aps_modis_SAR.m:198
        fclose(nointfid)
        data=reshape(data_vector,3,[]).T
# Trainmatlab.v.0/aps_modis_SAR.m:201
        noint=data[:,3]
# Trainmatlab.v.0/aps_modis_SAR.m:202
        clear('data','data_vector')
        # opening the gaussian interpolated file
        gaussfid=fopen(outfile_gauss,'r')
# Trainmatlab.v.0/aps_modis_SAR.m:207
        data_vector=fread(gaussfid,'double')
# Trainmatlab.v.0/aps_modis_SAR.m:208
        fclose(gaussfid)
        data=reshape(data_vector,3,[]).T
# Trainmatlab.v.0/aps_modis_SAR.m:211
        gauss=data[:,3]
# Trainmatlab.v.0/aps_modis_SAR.m:212
        xy=data[:,cat(arange(1,2))]
# Trainmatlab.v.0/aps_modis_SAR.m:213
        clear('data','data_vector')
        # (gaussian interpolated points only where no data available)
        noint[isnan(noint)]=0
# Trainmatlab.v.0/aps_modis_SAR.m:217
        gauss[noint != 0]=0
# Trainmatlab.v.0/aps_modis_SAR.m:218
        gauss_interp=gauss + noint
# Trainmatlab.v.0/aps_modis_SAR.m:219
        gauss_interp[gauss_interp == 0]=NaN
# Trainmatlab.v.0/aps_modis_SAR.m:220
        data_write=cat(xy,gauss_interp).T
# Trainmatlab.v.0/aps_modis_SAR.m:222
        clear('gauss_interp','noint','gauss')
        #output
        fid=fopen(outfile_gauss,'w')
# Trainmatlab.v.0/aps_modis_SAR.m:225
...
# Trainmatlab.v.0/aps_modis_SAR.m:234