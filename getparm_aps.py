...
# This script allows for non-StaMPS structured processed data.
    ...
    if nargin < 2:
        printflag=0
# matlab/getparm_aps.m:30
    
    parmfile='parms_aps.mat'
# matlab/getparm_aps.m:33
    if exist(cat('.',filesep,parmfile),'file'):
        parms=load(parmfile)
# matlab/getparm_aps.m:36
    else:
        if exist(cat('..',filesep,parmfile),'file'):
            parmfile=matlabarray(cat('..',filesep,parmfile))
# matlab/getparm_aps.m:38
            parms=load(parmfile)
# matlab/getparm_aps.m:39
        else:
