...
# matlab/aps_load_merra.m:77
            ...
            # definition of QV
            qv=copy(QV)
# matlab/aps_load_merra.m:92
            # Convert Geopotential Height to geopotential
    # important this is needed to be consitent with the other weather modules
            g0=9.80665
# matlab/aps_load_merra.m:97
            Geopot=multiply(H,g0)
# matlab/aps_load_merra.m:98
            lons=copy(lon)
# matlab/aps_load_merra.m:101
            lats=copy(lat)
# matlab/aps_load_merra.m:102
            clear('lon','lat')
            # define temperature
            Temp=copy(T)
# matlab/aps_load_merra.m:105
            clear('T')
            # define pressure
            Plevs=copy(lev)
# matlab/aps_load_merra.m:108
            clear('lev')
