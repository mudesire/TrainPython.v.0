...
# Trainmatlab.v.0/aps_wrf_files.m
...
###### CHANGES REQUIRED BY USER
    max_dom=2
# Trainmatlab.v.0/aps_wrf_files.m:39
    dx=25000
# Trainmatlab.v.0/aps_wrf_files.m:40
    dy=25000
# Trainmatlab.v.0/aps_wrf_files.m:41
    parent_grid_ratio=matlabarray(cat(1,5))
# Trainmatlab.v.0/aps_wrf_files.m:42
    i_parent_start=matlabarray(cat(1,10))
# Trainmatlab.v.0/aps_wrf_files.m:43
    j_parent_start=matlabarray(cat(1,8))
# Trainmatlab.v.0/aps_wrf_files.m:44
    e_we=matlabarray(cat(30,76))
# Trainmatlab.v.0/aps_wrf_files.m:45
    e_sn=matlabarray(cat(35,111))
# Trainmatlab.v.0/aps_wrf_files.m:46
    ref_lat=18.7
# Trainmatlab.v.0/aps_wrf_files.m:47
    ref_lon=- 102
# Trainmatlab.v.0/aps_wrf_files.m:48
    truelat1=30.0
# Trainmatlab.v.0/aps_wrf_files.m:49
    truelat2=60.0
# Trainmatlab.v.0/aps_wrf_files.m:50
    stand_lon=- 102
# Trainmatlab.v.0/aps_wrf_files.m:51
    map_proj='lambert'
# Trainmatlab.v.0/aps_wrf_files.m:52
    geog_data_path='/nfs/a1/software/geog'
# Trainmatlab.v.0/aps_wrf_files.m:53
    geog_data_res='3s'
# Trainmatlab.v.0/aps_wrf_files.m:54
    # larger 500 km track:
    i_parent_start=matlabarray(cat(1,10))
# Trainmatlab.v.0/aps_wrf_files.m:58
    j_parent_start=matlabarray(cat(1,8))
# Trainmatlab.v.0/aps_wrf_files.m:59
    e_we=matlabarray(cat(33,91))
# Trainmatlab.v.0/aps_wrf_files.m:60
    e_sn=matlabarray(cat(40,136))
# Trainmatlab.v.0/aps_wrf_files.m:61
...
# Trainmatlab.v.0/aps_wrf_files.m:81
    ll_matfile=getparm_aps('ll_matfile')
# Trainmatlab.v.0/aps_wrf_files.m:82
    UTC_sat=getparm_aps('UTC_sat')
# Trainmatlab.v.0/aps_wrf_files.m:83
    t_spin_up='12:00'
# Trainmatlab.v.0/aps_wrf_files.m:84
    
    data_intervals=6
# Trainmatlab.v.0/aps_wrf_files.m:85
    
    save_folder=getparm_aps('wrf_datapath')
# Trainmatlab.v.0/aps_wrf_files.m:86
    # loading the data
    if strcmp(stamps_processed,'y'):
        ps=load(ll_matfile)
# Trainmatlab.v.0/aps_wrf_files.m:91
        dates=ps.day
# Trainmatlab.v.0/aps_wrf_files.m:92
        load('psver')
        fprintf('Stamps processed structure \\n')
    else:
        psver=2
# Trainmatlab.v.0/aps_wrf_files.m:96
        ifgday_matfile=getparm_aps('ifgday_matfile')
# Trainmatlab.v.0/aps_wrf_files.m:97
        ifgs_dates=load(ifgday_matfile)
# Trainmatlab.v.0/aps_wrf_files.m:98
        ifgs_dates=ifgs_dates.ifgday
# Trainmatlab.v.0/aps_wrf_files.m:99
        dates=reshape(ifgs_dates,[],1)
# Trainmatlab.v.0/aps_wrf_files.m:100
        dates=unique(dates)
# Trainmatlab.v.0/aps_wrf_files.m:101
        dates=datenum(num2str(dates),'yyyymmdd')
# Trainmatlab.v.0/aps_wrf_files.m:102
    
    t_SAR=str2num(UTC_sat[1:2]) + str2num(UTC_sat[4:5]) / 60
# Trainmatlab.v.0/aps_wrf_files.m:104
    t_spin=str2num(t_spin_up[1:2]) + str2num(t_spin_up[4:5]) / 60
# Trainmatlab.v.0/aps_wrf_files.m:105
    # the weather model spin time:
    t_spin_model=copy(t_spin)
# Trainmatlab.v.0/aps_wrf_files.m:107
    t_start_model=t_SAR - t_spin
# Trainmatlab.v.0/aps_wrf_files.m:108
...
# Trainmatlab.v.0/aps_wrf_files.m:285
...
# Trainmatlab.v.0/aps_wrf_files.m:291
...
# Trainmatlab.v.0/aps_wrf_files.m:292
...
# Trainmatlab.v.0/aps_wrf_files.m:302
                lon_range[lon_range < - 180]=lon_range[lon_range < - 180] + 360
# Trainmatlab.v.0/aps_wrf_files.m:303
                lon_range[lon_range > 180]=lon_range[lon_range > 180] - 360
# Trainmatlab.v.0/aps_wrf_files.m:304
                lon_range=sort(lon_range)
# Trainmatlab.v.0/aps_wrf_files.m:305
                lat_range=matlabarray(cat(floor(ref_lat - dot((dy / 1000),e_sn[1]) / 110),ceil(ref_lat + dot((dy / 1000),e_sn[1]) / 110)))
# Trainmatlab.v.0/aps_wrf_files.m:306
                lat_range[lat_range < - 90]=- 90
# Trainmatlab.v.0/aps_wrf_files.m:307
                lat_range[lat_range > 90]=90
# Trainmatlab.v.0/aps_wrf_files.m:308
                lat_range=sort(lat_range)
# Trainmatlab.v.0/aps_wrf_files.m:309
...
# Trainmatlab.v.0/aps_wrf_files.m:310
...
# Trainmatlab.v.0/aps_wrf_files.m:314
...
# Trainmatlab.v.0/aps_wrf_files.m:315
...
# Trainmatlab.v.0/aps_wrf_files.m:317
...
# Trainmatlab.v.0/aps_wrf_files.m:323
            ...
            # This is not required for GFS data
                if kk > 1:
                    skip_flag=0
# Trainmatlab.v.0/aps_wrf_files.m:337
                else:
                    skip_flag=1
# Trainmatlab.v.0/aps_wrf_files.m:339
                if skip_flag == 0:
                    data_types=1
# Trainmatlab.v.0/aps_wrf_files.m:342
                    data_filename=matlabarray(cat(datestr(dates[k],'yyyy'),filesep,'GFS_Global_0p5deg_',data_time_str,'_anl.grib2 \\n'))
# Trainmatlab.v.0/aps_wrf_files.m:344
...
# Trainmatlab.v.0/aps_wrf_files.m:456
            fprintf(fid,cat('\\n&time_control\\n'))
...
# Trainmatlab.v.0/aps_wrf_files.m:598
                        file_prefix='\'PRESS\''
# Trainmatlab.v.0/aps_wrf_files.m:599
                        metgrid_prefix='\'SFC\',\'PRESS\''
# Trainmatlab.v.0/aps_wrf_files.m:600
                    else:
                        if ll == 2:
                            fid_wps=fopen(cat(save_folder,filesep,datestr(dates[k],'yyyymmdd'),filesep,'namelist.wps.surface'),'w')
# Trainmatlab.v.0/aps_wrf_files.m:603
                            file_prefix='\'SFC\''
# Trainmatlab.v.0/aps_wrf_files.m:604
                            metgrid_prefix='\'SFC\',\'PRESS\''
# Trainmatlab.v.0/aps_wrf_files.m:605
                else:
                    fid_wps=fopen(cat(save_folder,filesep,datestr(dates[k],'yyyymmdd'),filesep,'namelist.wps'),'w')
# Trainmatlab.v.0/aps_wrf_files.m:608
                    file_prefix='\'FILE\''
# Trainmatlab.v.0/aps_wrf_files.m:609
                    metgrid_prefix='\'FILE\''
# Trainmatlab.v.0/aps_wrf_files.m:610
                ### WPS file
