...
# Trainmatlab.v.0/load_wrf_SAR.m

    
@function
def load_wrf_SAR(filename=None,xy_out_grid=None,poly_crop_filename=None,*args,**kwargs):
    varargin = load_wrf_SAR.varargin
    nargin = load_wrf_SAR.nargin
...
#     51 Franklin Street, Fifth Floor, Boston, MA 02110-1301 USA.
    ...
    if nargin < 3 or isempty(poly_crop_filename):
        poly_crop_filename=matlabarray([])
# Trainmatlab.v.0/load_wrf_SAR.m:42
    
    if nargin < 2 or isempty(xy_out_grid):
        xy_out_grid=matlabarray([])
# Trainmatlab.v.0/load_wrf_SAR.m:45
    
    xyz_input,xyz_output=load_era_SAR(filename,xy_out_grid,poly_crop_filename,nargout=2)
# Trainmatlab.v.0/load_wrf_SAR.m:48