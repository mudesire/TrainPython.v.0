...
# matlab/aps_spectrometer_PWV_modis.m
...
# matlab/aps_spectrometer_PWV_modis.m:29
    
    xlims=getparm_aps('region_lon_range',1)
# matlab/aps_spectrometer_PWV_modis.m:30
    ylims=getparm_aps('region_lat_range',1)
# matlab/aps_spectrometer_PWV_modis.m:31
    stamps_processed=getparm_aps('stamps_processed',1)
# matlab/aps_spectrometer_PWV_modis.m:32
    ## the actual scripting
#bounds for all ifgms in degrees or in meters
    xmin=xlims[1]
# matlab/aps_spectrometer_PWV_modis.m:37
    xmax=xlims[2]
# matlab/aps_spectrometer_PWV_modis.m:38
    ymin=ylims[1]
# matlab/aps_spectrometer_PWV_modis.m:39
    ymax=ylims[2]
# matlab/aps_spectrometer_PWV_modis.m:40
    # getting the number of files to be processed
    files=char(textread(batchfile,'%s','headerlines',1))
# matlab/aps_spectrometer_PWV_modis.m:44
    ix_keep=matlabarray([])
# matlab/aps_spectrometer_PWV_modis.m:45
...
# matlab/aps_spectrometer_PWV_modis.m:48
    
    files=files[ix_keep,:]
# matlab/aps_spectrometer_PWV_modis.m:51
    # exclude recalibrated files
    ndates=size(files,1)
# matlab/aps_spectrometer_PWV_modis.m:53
    # loading the date information
    if strcmp(stamps_processed,'y'):
        ps=load(getparm_aps('ll_matfile',1))
# matlab/aps_spectrometer_PWV_modis.m:57
        ifgs_dates=ps.day
# matlab/aps_spectrometer_PWV_modis.m:58
        fprintf('Stamps processed structure \\n')
    else:
        ifgday_matfile=getparm_aps('ifgday_matfile',1)
# matlab/aps_spectrometer_PWV_modis.m:61
        ifgs_dates=load(ifgday_matfile)
# matlab/aps_spectrometer_PWV_modis.m:62
        ifgs_dates=ifgs_dates.ifgday
# matlab/aps_spectrometer_PWV_modis.m:63
        ifgs_dates=reshape(ifgs_dates,[],1)
# matlab/aps_spectrometer_PWV_modis.m:64
        ifgs_dates=unique(ifgs_dates)
# matlab/aps_spectrometer_PWV_modis.m:65
...
# matlab/aps_spectrometer_PWV_modis.m:91
        outfile_watervapor=matlabarray(cat(pathlist[n],filesep,datelist[n,:],'_ZPWV_nointerp.xyz'))
# matlab/aps_spectrometer_PWV_modis.m:92
        lon_grid,lat_grid,watervap=grdread2(file,nargout=3)
# matlab/aps_spectrometer_PWV_modis.m:93
        D=grdinfo2(file)
# matlab/aps_spectrometer_PWV_modis.m:95
        mod_xmin=D[1]
# matlab/aps_spectrometer_PWV_modis.m:96
        mod_xmax=D[2]
# matlab/aps_spectrometer_PWV_modis.m:97
        mod_ymin=D[3]
# matlab/aps_spectrometer_PWV_modis.m:98
        mod_ymax=D[4]
# matlab/aps_spectrometer_PWV_modis.m:99
        mod_cols=length(lon_grid)
# matlab/aps_spectrometer_PWV_modis.m:100
        mod_rows=length(lat_grid)
# matlab/aps_spectrometer_PWV_modis.m:101
        clear('D')
        ## Calculate wet delay
...
# matlab/aps_spectrometer_PWV_modis.m:109
        a,b=system(grdsmp_cmd,nargout=2)
# matlab/aps_spectrometer_PWV_modis.m:110
...
# matlab/aps_spectrometer_PWV_modis.m:111
        a,b=system(grd2xyz_cmd,nargout=2)
# matlab/aps_spectrometer_PWV_modis.m:112
        nointfid=fopen(outfile_watervapor,'r')
# matlab/aps_spectrometer_PWV_modis.m:116
        data_vector=fread(nointfid,'double')
# matlab/aps_spectrometer_PWV_modis.m:117
        fclose(nointfid)
        data=reshape(data_vector,3,[]).T
# matlab/aps_spectrometer_PWV_modis.m:120
        noint=data[:,3]
# matlab/aps_spectrometer_PWV_modis.m:121
        xy=data[:,cat(arange(1,2))]
# matlab/aps_spectrometer_PWV_modis.m:122
...
# matlab/aps_spectrometer_PWV_modis.m:128
        fid=fopen(outfile_watervapor,'w')
# matlab/aps_spectrometer_PWV_modis.m:129
...
# matlab/aps_spectrometer_PWV_modis.m:139