...
# matlab/aps_powerlaw_linear_local.m
...
# matlab/aps_powerlaw_linear_local.m:88
    debug_fig=0
# matlab/aps_powerlaw_linear_local.m:89
    n_points_min=50
# matlab/aps_powerlaw_linear_local.m:90
    
    n_boot_runs=1000
# matlab/aps_powerlaw_linear_local.m:91
    
    bootstrap_flag=1
# matlab/aps_powerlaw_linear_local.m:92
    
    # Get matlab version as function arguments change with the matlab version
    matlab_version=version('-release')
# matlab/aps_powerlaw_linear_local.m:96
    
    matlab_version=str2num(matlab_version[1:4])
# matlab/aps_powerlaw_linear_local.m:97
    
    if nargin < 5 or isempty(iterate) == 1:
        window_ix=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:101
        window_xy=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:102
        window_xy_extra=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:103
        ix_edges_window=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:104
        compute_windows=1
# matlab/aps_powerlaw_linear_local.m:105
    else:
        compute_windows=0
# matlab/aps_powerlaw_linear_local.m:107
    
    if nargin < 6 or isempty(dimension_filter):
        dimension_filter=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:110
...
# matlab/aps_powerlaw_linear_local.m:172
        width_y=(max(xy_local[:,2]) - min(xy_local[:,2]))
# matlab/aps_powerlaw_linear_local.m:173
        heading=getparm_aps('heading')
# matlab/aps_powerlaw_linear_local.m:176
        if n_patches != 0:
...
# matlab/aps_powerlaw_linear_local.m:181
            n_patches_x=ceil(width_x / patch_width)
# matlab/aps_powerlaw_linear_local.m:182
            n_patches_y=ceil(width_y / patch_width)
# matlab/aps_powerlaw_linear_local.m:183
...
# matlab/aps_powerlaw_linear_local.m:189
            patch_overlap_y=copy(patch_overlap)
# matlab/aps_powerlaw_linear_local.m:190
...
# matlab/aps_powerlaw_linear_local.m:202
            patch_c2c_x=patch_width_x - dot(patch_width_x,patch_overlap_x) / 100
# matlab/aps_powerlaw_linear_local.m:203
            patch_c2c=max(cat(patch_c2c_y,patch_c2c_x))
# matlab/aps_powerlaw_linear_local.m:204
        else:
            fprintf('Use an individual window \\n')
            patch_width_x=copy(width_x)
# matlab/aps_powerlaw_linear_local.m:207
            patch_width_y=copy(width_y)
# matlab/aps_powerlaw_linear_local.m:208
...
# matlab/aps_powerlaw_linear_local.m:213
...
# matlab/aps_powerlaw_linear_local.m:222
            tca_support=tca_support.powerlaw_ridges
# matlab/aps_powerlaw_linear_local.m:223
            mountain_ridge=tca_support.mountain_ridge
# matlab/aps_powerlaw_linear_local.m:224
            hard_ridge_flag=tca_support.hard_ridge_flag
# matlab/aps_powerlaw_linear_local.m:225
            mountain_ridge=mountain_ridge[logical_not(cellfun('isempty',mountain_ridge))]
# matlab/aps_powerlaw_linear_local.m:227
            mountain_ridge[length(mountain_ridge) + 1]=tca_support.InSAR_convexhull
# matlab/aps_powerlaw_linear_local.m:228
            hard_ridge_flag=matlabarray(cat(hard_ridge_flag,0))
# matlab/aps_powerlaw_linear_local.m:229
            heading=getparm_aps('heading')
# matlab/aps_powerlaw_linear_local.m:232
            xy_rotatelocal_all=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:235
            min_region=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:236
            max_region=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:237
...
# matlab/aps_powerlaw_linear_local.m:271
...
# matlab/aps_powerlaw_linear_local.m:293
                            x_vector=matlabarray(cat([x_vector],[x_sampling]))
# matlab/aps_powerlaw_linear_local.m:295
                            y_vector=matlabarray(cat([y_vector],[y_sampling]))
# matlab/aps_powerlaw_linear_local.m:296
                            z_vector=matlabarray(cat([z_vector],[multiply(z_ridge,ones(size(y_sampling)))]))
# matlab/aps_powerlaw_linear_local.m:297
                            if abs(mean(diff(y_sampling))) > 1.5:
                                # step in y direction is large -- change
                        # interpolation direction to scope with this
                                y_sampling=cat(arange(min(cat(ix_lines[kkk,2],ix_lines[kkk + 1,2])),max(cat(ix_lines[kkk,2],ix_lines[kkk + 1,2])))).T
# matlab/aps_powerlaw_linear_local.m:304
                                clear('x_sampling')
                                x_sampling=interp1(ix_lines[kkk:kkk + 1,2],ix_lines[kkk:kkk + 1,1],y_sampling)
# matlab/aps_powerlaw_linear_local.m:306
                                x_vector=matlabarray(cat([x_vector],[x_sampling]))
# matlab/aps_powerlaw_linear_local.m:307
                                y_vector=matlabarray(cat([y_vector],[y_sampling]))
# matlab/aps_powerlaw_linear_local.m:308
                                z_vector=matlabarray(cat([z_vector],[multiply(z_ridge,ones(size(y_sampling)))]))
# matlab/aps_powerlaw_linear_local.m:309
                    clear('x_sampling','y_sampling')
                clear('z_ridge')
            x_vector=round(x_vector)
# matlab/aps_powerlaw_linear_local.m:318
            y_vector=round(y_vector)
# matlab/aps_powerlaw_linear_local.m:319
            ix=sub2ind(size(matrix_patches),x_vector,y_vector)
# matlab/aps_powerlaw_linear_local.m:321
            matrix_patches[ix]=z_vector
# matlab/aps_powerlaw_linear_local.m:322
            matrix_patches=matrix_patches.T
# matlab/aps_powerlaw_linear_local.m:323
            H=fspecial('average',2)
# matlab/aps_powerlaw_linear_local.m:327
            matrix_patches_mean=imfilter(matrix_patches,H,'replicate')
# matlab/aps_powerlaw_linear_local.m:328
            matrix_patches_mean[matrix_patches_mean >= 1000]=10000
# matlab/aps_powerlaw_linear_local.m:329
            matrix_patches_mean[matrix_patches_mean > logical_and(0,matrix_patches_mean) < 1000]=100
# matlab/aps_powerlaw_linear_local.m:330
            clear('H')
...
# matlab/aps_powerlaw_linear_local.m:445
    ix_window=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:446
...
# matlab/aps_powerlaw_linear_local.m:452
            window_xy[1,1]=min(xy_local[:,1]) + width_x / 2
# matlab/aps_powerlaw_linear_local.m:453
            window_xy[1,2]=min(xy_local[:,2]) + width_y / 2
# matlab/aps_powerlaw_linear_local.m:454
            window_xy_extra=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:455
            ix_edges_window=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:456
            w_d=ones(cat(n_points,1))
# matlab/aps_powerlaw_linear_local.m:457
        else:
            ixy_local=matlabarray(cat(cat(arange(1,n_points)).T,xy_local))
# matlab/aps_powerlaw_linear_local.m:459
            counter=1
# matlab/aps_powerlaw_linear_local.m:460
            counter_all=1
# matlab/aps_powerlaw_linear_local.m:461
...
# matlab/aps_powerlaw_linear_local.m:464
                ix_temp=find(x_bounds[1] <= logical_and(ixy_local[:,2],ixy_local[:,2]) < x_bounds[2])
# matlab/aps_powerlaw_linear_local.m:465
                ixy_local_temp=ixy_local[ix_temp,:]
# matlab/aps_powerlaw_linear_local.m:466
                clear('ix_temp')
...
# matlab/aps_powerlaw_linear_local.m:470
                    ix_temp=find(y_bounds[1] <= logical_and(ixy_local_temp[:,3],ixy_local_temp[:,3]) < y_bounds[2])
# matlab/aps_powerlaw_linear_local.m:471
                    ix=ixy_local_temp[ix_temp,1]
# matlab/aps_powerlaw_linear_local.m:472
                    clear('ix_temp')
...
# matlab/aps_powerlaw_linear_local.m:479
                        window_xy[counter,1]=x_bounds[1] + (x_bounds[2] - x_bounds[1]) / 2
# matlab/aps_powerlaw_linear_local.m:482
                        window_xy[counter,2]=y_bounds[1] + (y_bounds[2] - y_bounds[1]) / 2
# matlab/aps_powerlaw_linear_local.m:483
...
# matlab/aps_powerlaw_linear_local.m:487
                        if flag_figure_checks == 1:
                            patch_colors=jet(dot((n_patches_x + 2),(n_patches_y + 2)))
# matlab/aps_powerlaw_linear_local.m:491
                            if counter == 1:
                                h1=figure('name','grid')
# matlab/aps_powerlaw_linear_local.m:493
                            else:
                                figure(h1)
                                hold('on')
...
# matlab/aps_powerlaw_linear_local.m:509
                        counter=counter + 1
# matlab/aps_powerlaw_linear_local.m:510
                    counter_all=counter_all + 1
# matlab/aps_powerlaw_linear_local.m:513
                    clear('ix')
...
# matlab/aps_powerlaw_linear_local.m:542
            edges=unique(edges)
# matlab/aps_powerlaw_linear_local.m:543
            edges,temp,ix_edges_window=intersect(edges,ix_window,nargout=3)
# matlab/aps_powerlaw_linear_local.m:545
            clear('counter_all','edges','temp')
            powerlaw_windows_edge=copy(ix_edges_window)
# matlab/aps_powerlaw_linear_local.m:548
            if exist('tca_support.mat') == 2:
...
# matlab/aps_powerlaw_linear_local.m:572
                weights_temp=normpdf(Distance_temp,0,patch_c2c)
# matlab/aps_powerlaw_linear_local.m:573
...
# matlab/aps_powerlaw_linear_local.m:580
        iterate.window_xy = copy(window_xy)
# matlab/aps_powerlaw_linear_local.m:581
        iterate.window_xy_extra = copy(window_xy_extra)
# matlab/aps_powerlaw_linear_local.m:582
        iterate.ix_edges_window = copy(ix_edges_window)
# matlab/aps_powerlaw_linear_local.m:583
        iterate.w_d = copy(w_d)
# matlab/aps_powerlaw_linear_local.m:584
        # they will be ignored on the next run
        ridges_flag='n'
# matlab/aps_powerlaw_linear_local.m:587
        patch_regions=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:588
        Ymesh_patch_regions=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:589
        Xmesh_patch_regions=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:590
        iterate.ridges_flag = copy(ridges_flag)
# matlab/aps_powerlaw_linear_local.m:592
        iterate.patch_regions = copy(patch_regions)
# matlab/aps_powerlaw_linear_local.m:593
        iterate.Ymesh_patch_regions = copy(Ymesh_patch_regions)
# matlab/aps_powerlaw_linear_local.m:594
        iterate.Xmesh_patch_regions = copy(Xmesh_patch_regions)
# matlab/aps_powerlaw_linear_local.m:595
    else:
        if compute_windows == 1 and strcmpi(powerlaw_ridge_constraint,'y'):
...
# matlab/aps_powerlaw_linear_local.m:604
            if flag_figure_checks == 1:
                figure
...
# matlab/aps_powerlaw_linear_local.m:623
            ...
            # getting the final number of windows
            n_windows=length(window_ix)
# matlab/aps_powerlaw_linear_local.m:642
            for kk in arange(1,n_windows).reshape(-1):
                X_windows=repmat(window_xy[:,1].T,n_windows,1)
# matlab/aps_powerlaw_linear_local.m:646
                Y_windows=repmat(window_xy[:,2].T,n_windows,1)
# matlab/aps_powerlaw_linear_local.m:647
                Distance_windows=sqrt((X_windows - X_windows.T) ** 2 + (Y_windows - Y_windows.T) ** 2)
# matlab/aps_powerlaw_linear_local.m:648
                Distance_windows_sorted=sort(Distance_windows,1)
# matlab/aps_powerlaw_linear_local.m:649
                patch_c2c=dot(2 / 3,mean(Distance_windows_sorted[2,:]))
# matlab/aps_powerlaw_linear_local.m:650
            # Computing weights based on distance from the points to the windows centers
            X_points=repmat(xy_local[:,1],1,n_windows)
# matlab/aps_powerlaw_linear_local.m:655
            Y_points=repmat(xy_local[:,2],1,n_windows)
# matlab/aps_powerlaw_linear_local.m:656
            X_windows=repmat(window_xy[:,1].T,n_points,1)
# matlab/aps_powerlaw_linear_local.m:657
            Y_windows=repmat(window_xy[:,2].T,n_points,1)
# matlab/aps_powerlaw_linear_local.m:658
            Distance=sqrt((X_points - X_windows) ** 2 + (Y_points - Y_windows) ** 2)
# matlab/aps_powerlaw_linear_local.m:659
            clear('X_points','Y_points','X_windows','Y_windows')
            dimensions=ceil(max(xy_local)) - floor(min(xy_local))
# matlab/aps_powerlaw_linear_local.m:663
            grid_resolution=10
# matlab/aps_powerlaw_linear_local.m:664
...
# matlab/aps_powerlaw_linear_local.m:667
            clear('dimensions')
            dimensions_grid=size(Xgrid)
# matlab/aps_powerlaw_linear_local.m:669
            Xgrid_vector=reshape(Xgrid,[],1)
# matlab/aps_powerlaw_linear_local.m:670
            Ygrid_vector=reshape(Ygrid,[],1)
# matlab/aps_powerlaw_linear_local.m:671
            X_points=repmat(Xgrid_vector,1,n_windows)
# matlab/aps_powerlaw_linear_local.m:674
            Y_points=repmat(Ygrid_vector,1,n_windows)
# matlab/aps_powerlaw_linear_local.m:675
            X_windows=repmat(window_xy[:,1].T,length(Ygrid_vector),1)
# matlab/aps_powerlaw_linear_local.m:676
            Y_windows=repmat(window_xy[:,2].T,length(Ygrid_vector),1)
# matlab/aps_powerlaw_linear_local.m:677
            Distance_grid=sqrt((X_points - X_windows) ** 2 + (Y_points - Y_windows) ** 2)
# matlab/aps_powerlaw_linear_local.m:678
            clear('X_points','Y_points','X_windows','Y_windows')
...
# matlab/aps_powerlaw_linear_local.m:729
                X_hard_ridge_edge=Xmesh_patch_regions[ix_hard_ridge_edges]
# matlab/aps_powerlaw_linear_local.m:730
                Y_hard_ridge_edge=Ymesh_patch_regions[ix_hard_ridge_edges]
# matlab/aps_powerlaw_linear_local.m:731
...
# matlab/aps_powerlaw_linear_local.m:739
                        P2=window_xy[kkk,:]
# matlab/aps_powerlaw_linear_local.m:740
                        ax=(P2[1,2] - P1[1,2]) / (P2[1,1] - P1[1,1])
# matlab/aps_powerlaw_linear_local.m:742
                        bx=dot(dot(- 1,ax),P1[1,1]) + P1[1,2]
# matlab/aps_powerlaw_linear_local.m:743
                        ay=(P2[1,1] - P1[1,1]) / (P2[1,2] - P1[1,2])
# matlab/aps_powerlaw_linear_local.m:744
                        by=dot(dot(- 1,ay),P1[1,2]) + P1[1,1]
# matlab/aps_powerlaw_linear_local.m:745
                        x_sampling=matlabarray(cat(arange(min(cat(P1[1],P2[1])),max(cat(P1[1],P2[1])))))
# matlab/aps_powerlaw_linear_local.m:746
                        y_sampling=matlabarray(cat(arange(min(cat(P1[2],P2[2])),max(cat(P1[2],P2[2])))))
# matlab/aps_powerlaw_linear_local.m:747
                        y_line=(dot(ax,x_sampling) + bx)
# matlab/aps_powerlaw_linear_local.m:748
                        x_line=(dot(ay,y_sampling) + by)
# matlab/aps_powerlaw_linear_local.m:749
...
# matlab/aps_powerlaw_linear_local.m:752
                        if sum(ix_temp) > 0:
...
# matlab/aps_powerlaw_linear_local.m:757
...
# matlab/aps_powerlaw_linear_local.m:762
                            YX_line_res=(abs(cat(x_line_res,y_sampling_res)))
# matlab/aps_powerlaw_linear_local.m:763
                            ix_ridge=sum(XY_line_res[:,1] < logical_and(1,XY_line_res[:,2]) < 1)
# matlab/aps_powerlaw_linear_local.m:765
                            ix_ridge=ix_ridge + sum(YX_line_res[:,1] < logical_and(1,YX_line_res[:,2]) < 1)
# matlab/aps_powerlaw_linear_local.m:766
                        else:
                            ix_ridge=0
# matlab/aps_powerlaw_linear_local.m:768
                        if ix_ridge > 0:
                            Distance_grid[kk,kkk]=NaN
# matlab/aps_powerlaw_linear_local.m:774
...
# matlab/aps_powerlaw_linear_local.m:947
            # Put the weight of the patches excluded due to mountains to zero.
            w_d[isnan(w_d)]=0
# matlab/aps_powerlaw_linear_local.m:950
            window_xy_extra=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:953
            ix_edges_window=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:954
            ridges_flag='y'
# matlab/aps_powerlaw_linear_local.m:955
            XYgrid_vector=matlabarray(cat(Xgrid_vector,Ygrid_vector))
# matlab/aps_powerlaw_linear_local.m:956
            n_grid_average=ceil(dot(2,patch_c2c) / grid_resolution)
# matlab/aps_powerlaw_linear_local.m:957
            iterate.window_ix = copy(window_ix)
# matlab/aps_powerlaw_linear_local.m:960
            iterate.window_xy = copy(window_xy)
# matlab/aps_powerlaw_linear_local.m:961
            iterate.window_xy_extra = copy(window_xy_extra)
# matlab/aps_powerlaw_linear_local.m:962
            iterate.ix_edges_window = copy(ix_edges_window)
# matlab/aps_powerlaw_linear_local.m:963
            iterate.w_d = copy(w_d)
# matlab/aps_powerlaw_linear_local.m:964
            iterate.ridges_flag = copy(ridges_flag)
# matlab/aps_powerlaw_linear_local.m:965
            iterate.patch_regions = copy(patch_regions)
# matlab/aps_powerlaw_linear_local.m:966
            iterate.Ymesh_patch_regions = copy(Ymesh_patch_regions)
# matlab/aps_powerlaw_linear_local.m:967
            iterate.Xmesh_patch_regions = copy(Xmesh_patch_regions)
# matlab/aps_powerlaw_linear_local.m:968
            iterate.XYgrid_vector = copy(XYgrid_vector)
# matlab/aps_powerlaw_linear_local.m:969
            iterate.grid_resolution = copy(grid_resolution)
# matlab/aps_powerlaw_linear_local.m:970
            iterate.n_grid_average = copy(n_grid_average)
# matlab/aps_powerlaw_linear_local.m:971
            iterate.dimensions_grid = copy(dimensions_grid)
# matlab/aps_powerlaw_linear_local.m:972
...
# matlab/aps_powerlaw_linear_local.m:1028
...
# matlab/aps_powerlaw_linear_local.m:1052
                slope_window_band_std_matrix[:,k]=slope_window_band_std
# matlab/aps_powerlaw_linear_local.m:1053
...
# matlab/aps_powerlaw_linear_local.m:1073
            n_points_window_original=length(ix_original)
# matlab/aps_powerlaw_linear_local.m:1075
            # initialisation of the variables
            slope_window_band=NaN(cat(n_datasets,1))
# matlab/aps_powerlaw_linear_local.m:1081
            slope_window_band_std=NaN(cat(n_datasets,1))
# matlab/aps_powerlaw_linear_local.m:1082
            slope_window_band_std_bootstrap=NaN(cat(n_datasets,1))
# matlab/aps_powerlaw_linear_local.m:1083
            slope_window_band_std_error_prop=NaN(cat(n_datasets,1))
# matlab/aps_powerlaw_linear_local.m:1084
            offset_window_band=NaN(cat(n_datasets,1))
# matlab/aps_powerlaw_linear_local.m:1085
            offset_window_band_std=NaN(cat(n_datasets,1))
# matlab/aps_powerlaw_linear_local.m:1086
            for kk in arange(1,n_datasets).reshape(-1):
...
# matlab/aps_powerlaw_linear_local.m:1174
                ...
                if isempty(dimension_filter) != 1:
                    Ax1=copy(gca)
# matlab/aps_powerlaw_linear_local.m:1190
                    ylims=get(Ax1,'ylim')
# matlab/aps_powerlaw_linear_local.m:1191
                    ixplot=find(dimension_filter == 1)
# matlab/aps_powerlaw_linear_local.m:1193
                    if isempty(ixplot) != 1:
                        filter_transition=ixplot[1]
# matlab/aps_powerlaw_linear_local.m:1195
                        hold('on')
...
# matlab/aps_powerlaw_linear_local.m:1214
    if n_windows == 1 and strcmp(plane_mode,'y'):
        # Checking if the troposheric delay needs to be computed for each bandfilter
        if strcmp(powerlaw_all_bands,'y'):
            for kk in arange(1,n_datasets).reshape(-1):
...
# matlab/aps_powerlaw_linear_local.m:1242
        fprintf('Plane mode \\n')
    else:
        # Checking if the troposheric delay needs to be computed for each bandfilter
        if strcmp(powerlaw_all_bands,'y'):
...
# matlab/aps_powerlaw_linear_local.m:1261
                w_std=repmat(w_std,size(w_d,1),1)
# matlab/aps_powerlaw_linear_local.m:1262
                w_std[(w_d == 0)]=0
# matlab/aps_powerlaw_linear_local.m:1263
                w_std=w_std / repmat(sum(w_std,2),1,n_windows)
# matlab/aps_powerlaw_linear_local.m:1264
                w=multiply(w_d,w_std)
# matlab/aps_powerlaw_linear_local.m:1267
                w=w / repmat(sum(w,2),1,n_windows)
# matlab/aps_powerlaw_linear_local.m:1268
                clear('w_std')
...
# matlab/aps_powerlaw_linear_local.m:1287
                    temp_matrix=reshape(slope_band_grid,dimensions_grid[1],[])
# matlab/aps_powerlaw_linear_local.m:1289
                    H=fspecial('average',n_grid_average)
# matlab/aps_powerlaw_linear_local.m:1292
                    temp_matrix_mean=imfilter(temp_matrix,H,'replicate')
# matlab/aps_powerlaw_linear_local.m:1293
                    slope_band_grid_mean=reshape(temp_matrix_mean,[],1)
# matlab/aps_powerlaw_linear_local.m:1295
                    if flag_figure_checks == 1:
                        figure
...
# matlab/aps_powerlaw_linear_local.m:1314
                else:
...
# matlab/aps_powerlaw_linear_local.m:1318
                clear('w')
                # compute delay from it
                ph_tropo_powerlaw_band[:,kk]=multiply(slope_band,(dot(h0[ifg_number],1000) - hgt) ** (alpha[ifg_number]))
# matlab/aps_powerlaw_linear_local.m:1323
                slope_local_band[:,kk]=slope_band
# matlab/aps_powerlaw_linear_local.m:1324
                clear('slope_band')
            clear('kk','slope_window_band_std_matrix','slope_window_band_matrix')
        else:
            ph_tropo_powerlaw_band=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:1329
            slope_local_band=matlabarray([])
# matlab/aps_powerlaw_linear_local.m:1330
        #     keyboard
...
# matlab/aps_powerlaw_linear_local.m:1337
        w_std=repmat(w_std,size(w_d,1),1)
# matlab/aps_powerlaw_linear_local.m:1338
        w_std[(w_d == 0)]=0
# matlab/aps_powerlaw_linear_local.m:1339
        w_std=w_std / repmat(sum(w_std,2),1,n_windows)
# matlab/aps_powerlaw_linear_local.m:1340
        w=multiply(w_d,w_std)
# matlab/aps_powerlaw_linear_local.m:1343
        w=w / repmat(sum(w,2),1,n_windows)
# matlab/aps_powerlaw_linear_local.m:1344
        clear('w_std')
        # Compute slope, c for each PS point and the long wavelength tropospheric signal for each ifgs
        if strcmpi(powerlaw_ridge_constraint,'y'):
            slope_grid=dot(w,slope_window)
# matlab/aps_powerlaw_linear_local.m:1349
            ix_pos=slope_window >= 0
# matlab/aps_powerlaw_linear_local.m:1351
            perc_cons_K=floor(dot((abs(sum(ix_pos) / length(slope_window) - 0.5) + 0.5),100))
# matlab/aps_powerlaw_linear_local.m:1352
            fprintf(cat(num2str(perc_cons_K),' perc of K are consistent in space \\n '))
            temp_matrix=reshape(slope_grid,dimensions_grid[1],[])
# matlab/aps_powerlaw_linear_local.m:1356
            H=fspecial('average',n_grid_average)
# matlab/aps_powerlaw_linear_local.m:1359
            temp_matrix_mean=imfilter(temp_matrix,H,'replicate')
# matlab/aps_powerlaw_linear_local.m:1360
            slope_grid_mean=reshape(temp_matrix_mean,[],1)
# matlab/aps_powerlaw_linear_local.m:1362
            slope_local=griddata(XYgrid_vector[:,1],XYgrid_vector[:,2],slope_grid_mean,xy_local[:,1],xy_local[:,2],'linear')
# matlab/aps_powerlaw_linear_local.m:1365
        else:
            perc_cons_K=copy(nan)
# matlab/aps_powerlaw_linear_local.m:1367
            slope_local=dot(w,slope_window)
# matlab/aps_powerlaw_linear_local.m:1368
        clear('w','w_d')
        if flag_figure_checks == 1 and debug_fig == 1:
            figure
...
# matlab/aps_powerlaw_linear_local.m:1381
            ylimits=get(gca,'ylim')
# matlab/aps_powerlaw_linear_local.m:1382
            title('slope')
            figure
