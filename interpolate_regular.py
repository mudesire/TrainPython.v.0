...
# Trainmatlab.v.0/interpolate_regular.m
...
# Trainmatlab.v.0/interpolate_regular.m:43
    
    if isempty(int_method) == 1:
        int_method='linear'
# Trainmatlab.v.0/interpolate_regular.m:46
    
    flag_control_fig=0
# Trainmatlab.v.0/interpolate_regular.m:48
    
    # converting the resolutions to km
    x_res=x_res / 1000
# Trainmatlab.v.0/interpolate_regular.m:52
    
    y_res=y_res / 1000
# Trainmatlab.v.0/interpolate_regular.m:53
    
    # The number of dataset specified
    n_datasets=size(z,2)
# Trainmatlab.v.0/interpolate_regular.m:56
    # computed grid extremes
    xy_min=min(xy_local)
# Trainmatlab.v.0/interpolate_regular.m:59
    xy_max=max(xy_local)
# Trainmatlab.v.0/interpolate_regular.m:60
...
# Trainmatlab.v.0/interpolate_regular.m:64
    # interpolate the grid:
    Z_regular=NaN(cat(size(X_regular),n_datasets))
# Trainmatlab.v.0/interpolate_regular.m:66
    tic
    for k in arange(1,n_datasets).reshape(-1):
        ix_nan=isnan(z[:,k])
# Trainmatlab.v.0/interpolate_regular.m:69
...
# Trainmatlab.v.0/interpolate_regular.m:70
