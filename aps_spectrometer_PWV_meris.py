...
# matlab/aps_spectrometer_PWV_meris.m
...
# August 2014
    ...
    fig_test=1
# matlab/aps_spectrometer_PWV_meris.m:22
...
# matlab/aps_spectrometer_PWV_meris.m:32
    
    xlims=getparm_aps('region_lon_range',1)
# matlab/aps_spectrometer_PWV_meris.m:33
    ylims=getparm_aps('region_lat_range',1)
# matlab/aps_spectrometer_PWV_meris.m:34
    stamps_processed=getparm_aps('stamps_processed',1)
# matlab/aps_spectrometer_PWV_meris.m:35
    ## the actual scripting
#bounds for all ifgs in degrees or in meters
    xmin=xlims[1]
# matlab/aps_spectrometer_PWV_meris.m:41
    xmax=xlims[2]
# matlab/aps_spectrometer_PWV_meris.m:42
    ymin=ylims[1]
# matlab/aps_spectrometer_PWV_meris.m:43
    ymax=ylims[2]
# matlab/aps_spectrometer_PWV_meris.m:44
    # getting the number of files to be processed
    files=char(textread(batchfile,'%s','headerlines',1))
# matlab/aps_spectrometer_PWV_meris.m:48
    ndates=size(files,1)
# matlab/aps_spectrometer_PWV_meris.m:49
    # loading the date information
    if strcmp(stamps_processed,'y'):
        ps=load(getparm_aps('ll_matfile',1))
# matlab/aps_spectrometer_PWV_meris.m:53
        ifgs_dates=ps.day
# matlab/aps_spectrometer_PWV_meris.m:54
        fprintf('Stamps processed structure \\n')
    else:
        ifgday_matfile=getparm_aps('ifgday_matfile',1)
# matlab/aps_spectrometer_PWV_meris.m:57
        ifgs_dates=load(ifgday_matfile)
# matlab/aps_spectrometer_PWV_meris.m:58
        ifgs_dates=ifgs_dates.ifgday
# matlab/aps_spectrometer_PWV_meris.m:59
        ifgs_dates=reshape(ifgs_dates,[],1)
# matlab/aps_spectrometer_PWV_meris.m:60
        ifgs_dates=unique(ifgs_dates)
# matlab/aps_spectrometer_PWV_meris.m:61
...
# matlab/aps_spectrometer_PWV_meris.m:91
        outfile_watervapor=matlabarray(cat(pathlist[n],filesep,datelist[n,:],'_ZPWV_nointerp.xyz'))
# matlab/aps_spectrometer_PWV_meris.m:92
        tifinfo=geotiffinfo(file)
# matlab/aps_spectrometer_PWV_meris.m:95
        mer_xmin=tifinfo.CornerCoords.X(1)
# matlab/aps_spectrometer_PWV_meris.m:96
        mer_xmax=tifinfo.CornerCoords.X(2)
# matlab/aps_spectrometer_PWV_meris.m:97
        mer_ymin=tifinfo.CornerCoords.Y(3)
# matlab/aps_spectrometer_PWV_meris.m:98
        mer_ymax=tifinfo.CornerCoords.Y(1)
# matlab/aps_spectrometer_PWV_meris.m:99
        mer_cols=tifinfo.Width
# matlab/aps_spectrometer_PWV_meris.m:100
        mer_rows=tifinfo.Height
# matlab/aps_spectrometer_PWV_meris.m:101
        mer_x=(mer_xmax - mer_xmin) / mer_cols
# matlab/aps_spectrometer_PWV_meris.m:102
        mer_y=(mer_ymax - mer_ymin) / mer_rows
# matlab/aps_spectrometer_PWV_meris.m:103
        meris=imread(file,'tif')
# matlab/aps_spectrometer_PWV_meris.m:105
...
# matlab/aps_spectrometer_PWV_meris.m:112
        #take certain bits of binary numbers (e.g. second bit, 1=cloud), and reshape
    #into matrix mask
        cloud=bin2dec(flagbin[:,2])
# matlab/aps_spectrometer_PWV_meris.m:118
        cloudmat=reshape(cloud,mer_rows,mer_cols)
# matlab/aps_spectrometer_PWV_meris.m:119
        cloudmat[cloudmat == 1]=NaN
# matlab/aps_spectrometer_PWV_meris.m:120
        # NaNs will penetrate through the stack
        pconf=bin2dec(flagbin[:,23])
# matlab/aps_spectrometer_PWV_meris.m:124
        pconfmat=reshape(pconf,mer_rows,mer_cols)
# matlab/aps_spectrometer_PWV_meris.m:125
        pconfmat[pconfmat == 1]=NaN
# matlab/aps_spectrometer_PWV_meris.m:126
        lowp=bin2dec(flagbin[:,24])
# matlab/aps_spectrometer_PWV_meris.m:127
        lowpmat=reshape(lowp,mer_rows,mer_cols)
# matlab/aps_spectrometer_PWV_meris.m:128
        lowpmat[lowpmat == 1]=NaN
# matlab/aps_spectrometer_PWV_meris.m:129
        maskmat=multiply(multiply(cloudmat,pconfmat),lowpmat)
# matlab/aps_spectrometer_PWV_meris.m:130
        maskmat[isnan(maskmat)]=1
# matlab/aps_spectrometer_PWV_meris.m:131
        se=strel('square',3)
# matlab/aps_spectrometer_PWV_meris.m:134
        maskmat=imdilate(maskmat,se)
# matlab/aps_spectrometer_PWV_meris.m:135
        maskmat[maskmat == 1]=NaN
# matlab/aps_spectrometer_PWV_meris.m:136
        maskmat[maskmat == 0]=1
# matlab/aps_spectrometer_PWV_meris.m:137
        #load water vapour
        watervap=meris[:,:,14]
# matlab/aps_spectrometer_PWV_meris.m:141
        #mask out dodgy pixels
        corwatervap=multiply(watervap,maskmat)
# matlab/aps_spectrometer_PWV_meris.m:143
        ### aditonal masking
    # water mask
        water=bin2dec(flagbin[:,3])
# matlab/aps_spectrometer_PWV_meris.m:148
        water=reshape(water,mer_rows,mer_cols)
# matlab/aps_spectrometer_PWV_meris.m:149
        se=strel('square',3)
# matlab/aps_spectrometer_PWV_meris.m:152
        water_new=imerode(water,se)
# matlab/aps_spectrometer_PWV_meris.m:153
        water_new[water_new == 1]=NaN
# matlab/aps_spectrometer_PWV_meris.m:154
        water_new[water_new == 0]=1
# matlab/aps_spectrometer_PWV_meris.m:155
        clear('water')
        corwatervap=multiply(corwatervap,water_new)
# matlab/aps_spectrometer_PWV_meris.m:157
        fid=fopen('out.bin','w')
# matlab/aps_spectrometer_PWV_meris.m:162
        corwatervap=corwatervap.T
# matlab/aps_spectrometer_PWV_meris.m:163
...
# matlab/aps_spectrometer_PWV_meris.m:168
        a,b=system(xyz2grd_cmd,nargout=2)
# matlab/aps_spectrometer_PWV_meris.m:169
...
# matlab/aps_spectrometer_PWV_meris.m:172
        a,b=system(grdsmp_cmd,nargout=2)
# matlab/aps_spectrometer_PWV_meris.m:173
...
# matlab/aps_spectrometer_PWV_meris.m:174
        a,b=system(grd2xyz_cmd,nargout=2)
# matlab/aps_spectrometer_PWV_meris.m:175
        # opening the data file (not-interpolated)
        nointfid=fopen(outfile_watervapor,'r')
# matlab/aps_spectrometer_PWV_meris.m:182
        data_vector=fread(nointfid,'double')
# matlab/aps_spectrometer_PWV_meris.m:183
        fclose(nointfid)
        data=reshape(data_vector,3,[]).T
# matlab/aps_spectrometer_PWV_meris.m:186
        noint=data[:,3]
# matlab/aps_spectrometer_PWV_meris.m:187
        xy=data[:,cat(arange(1,2))]
# matlab/aps_spectrometer_PWV_meris.m:188
...
# matlab/aps_spectrometer_PWV_meris.m:194
        clear('noint','xy')
        #output
        fid=fopen(outfile_watervapor,'w')
# matlab/aps_spectrometer_PWV_meris.m:197
...
# matlab/aps_spectrometer_PWV_meris.m:206